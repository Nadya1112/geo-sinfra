...
<div class="overflow-x-auto custom-scrollbar" wire:loading.class="opacity-50 transition-opacity duration-300" wire:target="search, show, filter, setFilter">
            <table class="w-full text-left text-sm whitespace-nowrap md:whitespace-normal hidden md:table">
                <thead class="bg-gradient-to-r from-gold-500 to-gold-600 dark:from-navy-900 dark:to-navy-800 border-b border-gold-600 dark:border-navy-800 shadow-sm dark:shadow-md">
                    <tr>
                        <th class="px-6 py-4 font-extrabold uppercase tracking-widest text-xs text-white dark:text-gold-500">Waktu Lapor</th>
                        <th class="px-6 py-4 font-extrabold uppercase tracking-widest text-xs text-white dark:text-gold-500">Pelapor</th>
                        <th class="px-6 py-4 font-extrabold uppercase tracking-widest text-xs text-white dark:text-gold-500">Laporan Kerusakan</th>
                        <th class="px-5 py-4 font-extrabold uppercase tracking-widest text-xs text-white dark:text-gold-500 text-center">Status</th>
                        <th class="px-5 py-4 font-extrabold uppercase tracking-widest text-xs text-white dark:text-gold-500 text-center">Aksi</th>
                    </tr>
                </thead>
