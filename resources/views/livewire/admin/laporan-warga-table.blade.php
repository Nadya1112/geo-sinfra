    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        ...
        <div class="flex flex-col md:flex-row items-center gap-3 w-full md:w-auto">
            ...
            <div class="flex items-center flex-1 min-w-0 w-full md:w-[480px] xl:w-[560px]">
                ...
                <button type="button" wire:click="$set('search', ''); $set('status', 'all')" class="bg-white dark:bg-navy-900/90 dark:backdrop-blur-xl border-y border-r border-slate-100 dark:border-white/10 px-4 md:px-5 py-2.5 rounded-r-2xl hover:bg-slate-50 dark:hover:bg-white/5 transition-all shadow-sm group shrink-0 relative" title="Reset Filter">
