<div>
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        ...
        <div class="flex flex-col md:flex-row items-center gap-3 w-full md:w-auto">
            ...
            {{-- Ekspor PDF Rekap --}}
            <a href="{{ route('admin.infrastruktur.export.pdf') }}" target="_blank"
                class="px-5 py-2.5 bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 hover:bg-red-600 hover:text-white border border-red-100 dark:border-red-500/20 hover:border-red-600 rounded-2xl text-xs font-bold transition-all shadow-sm flex items-center justify-center gap-2 w-full md:w-auto">
