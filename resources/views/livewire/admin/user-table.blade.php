    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        ...
        <div class="flex flex-col md:flex-row items-center gap-2 w-full md:w-auto">
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center w-full md:w-[400px]">
                ...
                <button type="button" class="w-full sm:w-auto bg-white border border-slate-100 sm:border-y sm:border-r sm:border-l-0 px-4 md:px-5 py-2.5 rounded-b-xl sm:rounded-b-none sm:rounded-r-2xl hover:bg-slate-50 transition-all shadow-sm group shrink-0 relative">
