<div>
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        ...
        <div class="flex flex-col md:flex-row items-center gap-3 w-full md:w-auto">
            ...
            <div class="flex items-center flex-1 min-w-0 w-full md:w-[380px] xl:w-[450px]">
            ...
            <a href="{{ route('admin.users.create') }}" wire:navigate class="w-full md:w-auto bg-gold-500 text-white text-xs px-5 py-2.5 rounded-2xl font-bold shadow-lg shadow-gold-500/10 hover:bg-gold-600 hover:shadow-gold-500/20 transition flex items-center justify-center gap-2 whitespace-nowrap shrink-0">
