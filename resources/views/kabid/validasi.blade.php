                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td class="px-6 py-3 min-w-[250px]">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h4 class="text-[13px] font-black text-[#1e1b4b] leading-tight">{{ $item->nama_objek }}</h4>
                                            <p class="text-[9px] font-bold text-indigo-500 uppercase tracking-tighter mt-0.5">{{ $item->jenis }}</p>
                                        </div>
                                    </div>
                                </td>
