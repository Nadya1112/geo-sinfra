    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto">
        ...
        <div class="p-8 space-y-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <a href="{{ route('kabid.monitoring') }}" class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all group relative overflow-hidden">
                ...
                <a href="{{ route('kabid.statistik.tahunan') }}" class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all group relative overflow-hidden">
                ...
                <a href="{{ route('kabid.laporan') }}" class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all group relative overflow-hidden">
                            ...
                            <tr class="group hover:bg-gray-50/80 transition-all rounded-3xl">
                                <td class="px-6 py-4 bg-gray-50/50 group-hover:bg-white first:rounded-l-3xl transition-all border-y border-transparent group-hover:border-gray-100">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p class="font-black text-sm text-[#1e1b4b]">{{ $report->nama_objek }}</p>
                                            <p class="text-[9px] font-bold text-gray-400 uppercase">{{ $report->jenis }}</p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 bg-gray-50/50 group-hover:bg-white last:rounded-r-3xl transition-all border-y border-transparent group-hover:border-gray-100">
                                    <a href="{{ route('kabid.infrastruktur.show', $report->id_infrastruktur) }}" class="w-8 h-8 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center hover:bg-indigo-600 hover:text-white transition-all shadow-sm" title="Lihat Detail">
