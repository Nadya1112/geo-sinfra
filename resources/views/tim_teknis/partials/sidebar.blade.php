...
<aside class="w-20 lg:w-64 bg-navy-900 text-navy-900 dark:text-white flex-col hidden md:flex shadow-2xl z-20 text-left shrink-0 border-r border-navy-800 transition-all duration-300">
