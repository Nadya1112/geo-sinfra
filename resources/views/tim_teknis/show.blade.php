                        ...
                        <div class="relative aspect-[3/4] w-full rounded-[2rem] overflow-hidden group bg-navy-950 flex items-center justify-center">
                            @if($fotoUrl)
                                ...
                                <div class="absolute inset-0 bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                    <a href="{{ $fotoUrl }}" target="_blank" class="bg-white dark:bg-[#1e1b4b] text-navy-900 dark:text-white px-4 py-2 rounded-xl text-xs font-black shadow-xl uppercase tracking-widest hover:scale-105 transition-all flex items-center gap-2">
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="pt-6 border-t border-white/10">
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <span class="px-3 py-1 bg-white/5 dark:bg-[#1e1b4b]/5 border border-white/10 rounded-lg text-xs font-black uppercase tracking-widest {{ $infrastruktur->status_verifikasi == 'Verified' ? 'text-[#059669]' : 'text-amber-400' }}">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white dark:bg-[#1e1b4b] rounded-[2.5rem] p-8 border border-slate-100 dark:border-white/10 shadow-sm">
                        <div class="flex justify-between items-start mb-8">
                            <div>
                                <p class="text-xs font-black text-gold-500 uppercase tracking-widest mb-1">{{ ucfirst($infrastruktur->jenis) }}</p>
