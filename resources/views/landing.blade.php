            ...
            <div class="flex items-center gap-2 md:gap-4">
                ...
                <div class="relative group/theme">
                    <button type="button" onclick="document.getElementById('theme-dropdown').classList.toggle('hidden')" class="w-9 h-9 bg-white dark:bg-navy-900 rounded-xl flex items-center justify-center text-slate-400 hover:text-gold-500 hover:bg-gold-50 dark:hover:bg-white/5 border border-slate-200 dark:border-white/10 transition-all shadow-sm relative z-[6000] cursor-pointer">
                        <i class="fas fa-sun theme-toggle-sun pointer-events-none"></i>
                        <i class="fas fa-moon theme-toggle-moon pointer-events-none"></i>
                    </button>
                    <!-- Dropdown Content -->
                    ...
                    <div class="relative hidden md:block">
                        ...
                        <div id="filter-kategori-desktop" class="hidden absolute top-full left-0 mt-2 p-2 bg-white/95 dark:bg-[#0f0e2c]/95 backdrop-blur-2xl rounded-xl border border-slate-200 dark:border-white/10 shadow-2xl flex flex-col gap-2 min-w-[200px] max-h-[70vh] overflow-y-auto custom-scrollbar z-[10000]">
                            ...
                            <div>
                                ...
                                <label class="w-full px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider text-slate-600 dark:text-gray-400 hover:bg-slate-100 dark:hover:bg-white/10 transition-all flex items-center justify-between group cursor-pointer border-b border-slate-200 dark:border-white/5 mb-1 pb-2">
                                    <input type="checkbox" id="check-all-categories" class="peer hidden" checked>
                                    <div class="flex items-center gap-1.5">
                                        <div class="w-3 h-3 rounded border border-slate-300 dark:border-white/20 peer-checked:border-gold-500 flex items-center justify-center transition-colors">
                                            <i class="fas fa-check text-[7px] text-gold-500 opacity-0 peer-checked:opacity-100 transition-opacity"></i>
                                        </div>
                                        <span class="text-gold-500 group-hover:text-gold-600 transition-colors">Pilih Semua</span>
                                    </div>
                                </label>
                                @php
                                ...
                                <label class="w-full px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider text-slate-600 dark:text-gray-400 hover:bg-slate-100 dark:hover:bg-white/10 transition-all flex items-center justify-between group cursor-pointer">
                                    <input type="checkbox" class="filter-category peer hidden" value="{{ strtolower($kategori) }}" checked>
                                    <div class="flex items-center gap-1.5">
                                        <div class="w-3 h-3 rounded border border-slate-300 dark:border-white/20 peer-checked:border-gold-500 flex items-center justify-center transition-colors">
                                            <i class="fas fa-check text-[7px] text-gold-500 opacity-0 peer-checked:opacity-100 transition-opacity"></i>
                                        </div>
                                        <span class="group-hover:text-navy-900 dark:group-hover:text-white transition-colors">{{ $kategori }}</span>
                                    </div>
                                </label>
                                @endforeach
                            </div>
                            ...
                            <div class="border-t border-slate-200 dark:border-white/10 pt-2 flex flex-col gap-1.5">
                                <label class="w-full px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider text-slate-600 dark:text-gray-400 hover:bg-slate-100 dark:hover:bg-white/10 transition-all flex items-center justify-between group cursor-pointer border border-slate-200 dark:border-white/5 bg-slate-50 dark:bg-white/5 mt-1">
                                    <input type="checkbox" id="toggle-kelurahan-lines" class="peer hidden" checked>
                                    <div class="flex items-center gap-1.5">
                                        <div class="w-3 h-3 rounded border border-slate-300 dark:border-white/20 peer-checked:border-gold-500 flex items-center justify-center transition-colors">
                                            <i class="fas fa-check text-[7px] text-gold-500 opacity-0 peer-checked:opacity-100 transition-opacity"></i>
                                        </div>
                                        <span class="group-hover:text-navy-900 dark:group-hover:text-white transition-colors">Batas Kelurahan</span>
                                    </div>
                    ...
                    <div class="relative hidden md:block">
                        ...
                        <div id="filter-wilayah-desktop" class="hidden absolute top-full left-0 mt-2 p-2 bg-white/95 dark:bg-[#0f0e2c]/95 backdrop-blur-2xl rounded-xl border border-slate-200 dark:border-white/10 shadow-2xl flex flex-col gap-2 min-w-[240px] max-h-[70vh] overflow-y-auto custom-scrollbar z-[10000]">
                            ...
                            <div>
                                ...
                                <label class="w-full px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider text-slate-600 dark:text-gray-400 hover:bg-slate-100 dark:hover:bg-white/10 transition-all flex items-center justify-between group cursor-pointer border-b border-slate-200 dark:border-white/5 mb-1 pb-2">
                                    <input type="checkbox" id="check-all-districts" class="peer hidden" checked>
                                    <div class="flex items-center gap-1.5">
                                        <div class="w-3 h-3 rounded border border-slate-300 dark:border-white/20 peer-checked:border-gold-500 flex items-center justify-center transition-colors">
                                            <i class="fas fa-check text-[7px] text-gold-500 opacity-0 peer-checked:opacity-100 transition-opacity"></i>
                                        </div>
                                ...
                                <label class="w-full px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider text-slate-600 dark:text-gray-400 hover:bg-slate-100 dark:hover:bg-white/10 transition-all flex items-center justify-between group cursor-pointer">
                                    <input type="checkbox" class="filter-district peer hidden" value="{{ $wil->id_kecamatan }}" checked>
                                    <div class="flex items-center gap-1.5">
                                        <div class="w-3 h-3 rounded border border-slate-300 dark:border-white/20 peer-checked:border-gold-500 flex items-center justify-center transition-colors shrink-0">
                                            <i class="fas fa-check text-[7px] text-gold-500 opacity-0 peer-checked:opacity-100 transition-opacity"></i>
                                        </div>
                                        <span class="whitespace-normal leading-tight group-hover:text-navy-900 dark:group-hover:text-white transition-colors text-left">{{ $wil->nama_kecamatan }}</span>
                                    </div>
                                    <div class="w-3 h-3 rounded border border-white/10 shrink-0" style="background-color: {{ $kecColors[$index % count($kecColors)] }}"></div>
                                </label>
                                @endforeach
                                <label class="w-full px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider text-slate-600 dark:text-gray-400 hover:bg-slate-100 dark:hover:bg-white/10 transition-all flex items-center justify-between group cursor-pointer">
                                    <input type="checkbox" class="filter-district peer hidden" value="" checked>
                                    <div class="flex items-center gap-1.5">
                                        <div class="w-3 h-3 rounded border border-slate-300 dark:border-white/20 peer-checked:border-gold-500 flex items-center justify-center transition-colors shrink-0">
                                            <i class="fas fa-check text-[7px] text-gold-500 opacity-0 peer-checked:opacity-100 transition-opacity"></i>
                                        </div>
                                        <span class="whitespace-normal leading-tight group-hover:text-navy-900 dark:group-hover:text-white transition-colors text-left">Tanpa Wilayah</span>
                                    </div>
                                    <div class="w-3 h-3 rounded border border-white/10 shrink-0" style="background-color: #94a3b8"></div>
                                </label>
                            </div>
                        ...
                        <div class="overflow-y-auto custom-scrollbar flex flex-col gap-4 p-6 pt-4 pb-10 flex-1">
                            ...
                            <div class="w-full">
                                ...
                                <div class="bg-slate-50 dark:bg-white/5 rounded-xl border border-slate-200 dark:border-white/5 p-2 flex flex-col gap-1">
                                    <label class="w-full px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider text-slate-600 dark:text-gray-400 hover:bg-slate-100 dark:hover:bg-white/10 transition-all flex items-center justify-between group cursor-pointer border-b border-slate-200 dark:border-white/5 mb-1 pb-2">
                                        <input type="checkbox" id="check-all-categories-mobile" class="peer hidden" checked>
                                        <div class="flex items-center gap-1.5">
                                            <div class="w-3 h-3 rounded border border-slate-300 dark:border-white/20 peer-checked:border-gold-500 flex items-center justify-center transition-colors">
                                                <i class="fas fa-check text-[7px] text-gold-500 opacity-0 peer-checked:opacity-100 transition-opacity"></i>
                                            </div>
                            ...
                            <div class="w-full">
                                ...
                                <div class="bg-slate-50 dark:bg-white/5 rounded-xl border border-slate-200 dark:border-white/5 p-2 flex flex-col gap-1 max-h-[30vh] overflow-y-auto custom-scrollbar">
                                    <label class="w-full px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider text-slate-600 dark:text-gray-400 hover:bg-slate-100 dark:hover:bg-white/10 transition-all flex items-center justify-between group cursor-pointer border-b border-slate-200 dark:border-white/5 mb-1 pb-2">
                                        <input type="checkbox" id="check-all-districts-mobile" class="peer hidden" checked>
                                        <div class="flex items-center gap-1.5">
                                            <div class="w-3 h-3 rounded border border-slate-300 dark:border-white/20 peer-checked:border-gold-500 flex items-center justify-center transition-colors">
                                                <i class="fas fa-check text-[7px] text-gold-500 opacity-0 peer-checked:opacity-100 transition-opacity"></i>
                                            </div>
