        ...
        <header class="bg-white/85 dark:bg-navy-950/80 backdrop-blur-xl border-b border-slate-100 dark:border-white/10 dark:border-white/5 px-4 pl-16 md:px-8 py-4 flex justify-between items-center z-40 text-left transition-colors duration-300">
            <div class="flex items-center gap-4 text-left ml-10 md:ml-0">
                ...
                <div class="text-left">
                    ...
                    <h2 class="text-xl font-black text-navy-900 dark:text-white dark:text-white leading-none">Laporan Warga</h2>
                </div>
            </div>
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-6 md:p-8 bg-slate-50/50">
            <div class="max-w-7xl mx-auto space-y-6">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-2">
                    <div>
                        <h4 class="font-extrabold text-lg text-navy-900 dark:text-white">Data Laporan Warga</h4>
                        <p class="text-xs text-slate-400 dark:text-slate-300 font-semibold mt-0.5">Pantau, proses, dan kelola laporan kerusakan dari masyarakat</p>
                    </div>
                ...
                @livewire('admin.laporan-warga-table')
