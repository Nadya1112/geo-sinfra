                        ...
                        <tr class="hover:bg-slate-50/50 transition">
                            ...
                            <td class="px-8 py-5">
                                <div class="flex justify-center gap-2">
                                    ...
                                    @else
                                    <span class="px-3 h-8 bg-slate-100 text-slate-400 text-xs font-bold rounded-lg flex items-center justify-center cursor-not-allowed gap-2" title="Akun Tim Teknis dilindungi sistem">
