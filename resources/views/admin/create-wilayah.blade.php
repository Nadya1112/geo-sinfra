                ...
                <form action="{{ route('admin.wilayah.store') }}" method="POST">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="id_kecamatan" value="{{ old('id_kecamatan') }}" placeholder="Contoh: 637101" class="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-semibold focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all" required>
                            <p class="text-[10px] text-gray-400 mt-2 font-medium">Gunakan kode unik untuk setiap kecamatan.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-gray-400 mt-2 font-medium">Tuliskan nama langsung tanpa awalan "Kec."</p>
                        </div>
