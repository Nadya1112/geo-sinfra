                ...
                <form action="{{ route('admin.users.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                    ...
                    <div class="space-y-6 text-left">
                        ...
                        <div class="pt-10 flex gap-3 text-left">
                            ...
                            <a href="{{ route('admin.users') }}" class="flex-1 bg-gray-100 text-gray-500 text-xs px-6 py-4 rounded-2xl font-bold hover:bg-gray-200 transition text-center flex items-center justify-center gap-2 text-left">
