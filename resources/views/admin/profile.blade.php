        ...
        <header class="bg-white/80 backdrop-blur-xl border-b border-slate-100 dark:border-white/10 px-4 md:px-8 py-4 flex justify-between items-center z-40 shrink-0">
            <div class="flex items-center gap-2 md:gap-4">
                ...
                <div>
                    ...
                    <h2 class="text-lg md:text-xl font-black text-navy-900 dark:text-white dark:text-white leading-none">Profil Saya</h2>
                </div>
            </div>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white dark:bg-navy-900/90 dark:backdrop-blur-xl rounded-[2.5rem] p-8 border border-slate-100 dark:border-white/10 shadow-sm text-center relative overflow-hidden">
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white dark:bg-navy-900/90 dark:backdrop-blur-xl rounded-[2.5rem] p-10 border border-slate-100 dark:border-white/10 shadow-sm">
                            <div class="mb-8 border-b border-slate-100 dark:border-white/10 pb-5">
                                ...
                                <p class="text-xs text-slate-400 dark:text-slate-300 font-semibold mt-1">Perbarui informasi dasar dan kredensial akun Administrator Anda</p>
                            </div>
                            ...
                            <div class="space-y-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" name="name" value="{{ auth()->user()->name }}" 
                                               class="w-full px-5 py-3.5 bg-slate-50 dark:bg-navy-950/50 border border-slate-200 dark:border-white/10 rounded-2xl text-sm font-semibold outline-none focus:border-gold-500 focus:ring-4 focus:ring-gold-500/10 transition-all text-navy-900 dark:text-white" required>
                                    </div>
                                ...
                                <div class="pt-6 border-t border-slate-100 dark:border-white/10">
                                    <div class="flex items-center gap-3 mb-5">
                                        <div class="w-8 h-8 bg-slate-100 dark:bg-navy-950/50 rounded-lg flex items-center justify-center text-slate-400 dark:text-slate-300">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <input type="password" name="password" 
                                                   class="w-full px-5 py-3.5 bg-slate-50 dark:bg-navy-950/50 border border-slate-200 dark:border-white/10 rounded-2xl text-sm font-semibold outline-none focus:border-gold-500 focus:ring-4 focus:ring-gold-500/10 transition-all text-navy-900 dark:text-white placeholder:text-slate-300" placeholder="••••••••">
                                        </div>
                                        <div>
