                    ...
                    <div class="space-y-6 pt-6 border-t border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="material_eksisting" value="{{ $inf->material_eksisting }}" placeholder="Contoh: Kayu Ulin, Beton, Paving" class="w-full px-5 py-3 bg-orange-50/30 border border-orange-100 rounded-2xl text-sm font-semibold outline-none focus:border-orange-500">
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <textarea name="kondisi" rows="3" class="w-full px-5 py-3 bg-orange-50/30 border border-orange-100 rounded-2xl text-sm font-semibold outline-none focus:border-orange-500" placeholder="Contoh: titian putus, cor beton retak, amblas">{{ $inf->kondisi }}</textarea>
