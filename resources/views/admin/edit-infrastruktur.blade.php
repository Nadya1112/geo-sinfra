...
<head>
    ...
    <style>
        ...
        /* Input focus ring */
        .field-input {
            @apply w-full px-4 py-3 bg-slate-50 dark:bg-navy-950/50 border border-slate-200 dark:border-white/10 rounded-xl text-sm font-semibold text-slate-700 dark:text-slate-300 outline-none
        ...
        <header class="bg-white/80 backdrop-blur-xl border-b border-slate-100 dark:border-white/10 px-4  md:px-8 py-4 flex justify-between items-center z-40 shrink-0">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h2 class="text-xl font-black text-navy-900 dark:text-white dark:text-white leading-none">Edit Data Infrastruktur</h2>
                </div>
            </div>
                ...
                <div class="max-w-4xl mx-auto space-y-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white dark:bg-navy-900/90 dark:backdrop-blur-xl rounded-3xl border border-slate-100 dark:border-white/10 shadow-sm p-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    <label class="block text-xs font-black text-navy-900 dark:text-white uppercase tracking-widest mb-2">Jenis Infrastruktur</label>
                                    <input type="hidden" name="jenis" value="{{ $inf->jenis }}">
                                    <div class="w-full px-4 py-3 bg-slate-100 dark:bg-navy-950/50 border border-slate-200 dark:border-white/10 rounded-xl flex items-center justify-between cursor-not-allowed">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white dark:bg-navy-900/90 dark:backdrop-blur-xl rounded-3xl border border-slate-100 dark:border-white/10 shadow-sm p-6">
                            ...
                            <div class="relative rounded-2xl overflow-hidden border border-slate-100 dark:border-white/10 bg-slate-50 dark:bg-navy-950/50 h-52 flex items-center justify-center group">
                                ...
                                <div class="absolute inset-0 bg-black/30 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                    <span class="bg-white/90 dark:bg-navy-950/80 px-4 py-2 rounded-xl text-xs font-black text-navy-900 dark:text-white uppercase tracking-widest shadow-xl">
