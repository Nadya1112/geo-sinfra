            ...
            <div class="max-w-7xl mx-auto">
                ...
                <form id="survey-form" action="{{ route('surveyor.infrastruktur.update', $infrastruktur->id_infrastruktur) }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-12 gap-8" onsubmit="disableSubmitButton()">
                        ...
                        <div class="bg-white  rounded-[2.5rem] p-8 border border-slate-100  shadow-sm hover:shadow-md transition-shadow">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex gap-2">
                                        @if($infrastruktur->cnn)
                                            <span class="px-3 py-1.5 rounded-xl bg-white  border border-slate-200  text-xs font-black text-slate-500 shadow-sm">
                                                CNN: <span class="text-navy-900 ">{{ number_format($infrastruktur->cnn->skor_cnn * 100, 1) }}%</span>
                                            </span>
                                        @endif
                            ...
                            <div class="space-y-6">
                                <div class="grid grid-cols-1 gap-5">
                                    <div>
                                        ...
                                        <div class="relative group">
                                            ...
                                            <input type="text" name="nama_infrastruktur" value="{{ old('nama_infrastruktur', $infrastruktur->nama_objek) }}" placeholder="Contoh: Gg. Manggis RT 02 / Jalan Hasan Basry" class="w-full pl-12 pr-5 py-4 bg-slate-50  border border-slate-200  rounded-2xl text-sm font-semibold focus:ring-4 focus:ring-gold-500/10 focus:border-gold-500 outline-none transition-all text-navy-900 " required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div>
                                        <label class="block text-xs font-black text-navy-900  uppercase tracking-widest mb-3 ml-1">
                        ...
                        <div class="bg-white  rounded-[2.5rem] p-8 border border-slate-100  shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <div class="space-y-6">
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="relative group">
                                                    ...
                                                    <input type="number" step="0.01" name="lebar" value="{{ old('lebar', $infrastruktur->lebar) }}" placeholder="0.00" class="w-full pl-12 pr-5 py-3.5 bg-slate-50  border border-slate-200  rounded-2xl text-sm font-semibold focus:ring-4 focus:ring-gold-500/10 focus:border-gold-500 outline-none transition-all text-navy-900 " required>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="pt-4 border-t border-slate-50">
                                    ...
                                    <div class="relative group">
                                        <textarea name="kondisi" id="kondisi-textarea" rows="3" placeholder="Deskripsikan kerusakan spesifik..." class="w-full px-5 py-4 bg-slate-50  border border-slate-200  rounded-2xl text-sm font-semibold focus:ring-4 focus:ring-gold-500/10 focus:border-gold-500 outline-none transition-all text-navy-900 ">{{ old('kondisi', $infrastruktur->kondisi) }}</textarea>
                                    </div>
                                    <p class="text-xs text-slate-400 mt-2 italic font-medium px-2">* Memperbarui deskripsi akan menyebabkan AI menghitung ulang prioritas.</p>
                                </div>
                    ...
                    <div class="lg:col-span-5 space-y-8">
                        ...
                        <div class="bg-white  rounded-[2.5rem] p-8 border border-slate-100  shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <div class="relative rounded-[2rem] border-[6px] border-slate-50 shadow-inner overflow-hidden mb-6 h-[260px]">
                                ...
                                <div class="absolute bottom-4 left-4 right-4 z-10">
                                    <div class="bg-white/90  backdrop-blur-md px-4 py-3 rounded-xl shadow-lg border border-slate-100  text-center flex items-center justify-center gap-2">
                                        ...
                                        <p class="text-xs font-black uppercase tracking-widest text-navy-900 ">Klik Peta Untuk Menggeser Pin</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="bg-slate-50  p-4 rounded-2xl border border-slate-200 ">
                                    ...
                                    <input type="text" id="lat-input" name="latitude" value="{{ old('latitude', $infrastruktur->latitude) }}" class="w-full bg-transparent border-none p-0 text-xs font-black text-navy-900  outline-none focus:ring-0">
                                </div>
                                <div class="bg-slate-50  p-4 rounded-2xl border border-slate-200 ">
                                    <label class="block text-xs font-black text-slate-400 uppercase tracking-[0.2em] mb-1">Longitude</label>
                                    <input type="text" id="lng-input" name="longitude" value="{{ old('longitude', $infrastruktur->longitude) }}" class="w-full bg-transparent border-none p-0 text-xs font-black text-navy-900  outline-none focus:ring-0">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white  rounded-[2.5rem] p-8 border border-slate-100  shadow-sm hover:shadow-md transition-shadow">
                            <h4 class="text-xs font-black text-navy-900  mb-6 border-b border-slate-50 pb-4 uppercase tracking-widest">Dokumentasi Visual (Terkunci)</h4>
                            <div class="relative rounded-[2rem] overflow-hidden border border-slate-100  shadow-inner bg-slate-50  h-52 flex items-center justify-center mb-8">
                                ...
                                @else
                                    <div class="text-center">
                                        ...
                                        <p class="text-xs font-bold text-slate-400 uppercase">Tidak ada foto</p>
                                    </div>
                                @endif
                                <div class="absolute inset-0 bg-navy-900/40 flex items-center justify-center backdrop-blur-[2px]">
                                    <span class="px-5 py-2.5 bg-white/95  backdrop-blur-md rounded-xl text-xs font-black text-navy-900  uppercase tracking-widest border border-slate-200  shadow-lg flex items-center gap-2">
                            ...
                            <div class="grid grid-cols-1 gap-4 pt-4 border-t border-slate-100 ">
                                <div class="flex items-center justify-between px-2 mb-2">
                                    <span class="text-xs font-black text-slate-400 uppercase tracking-widest">Tgl Survey: <span class="text-navy-900 ">{{ \Carbon\Carbon::parse($infrastruktur->tgl_survey)->translatedFormat('d M Y') }}</span></span>
