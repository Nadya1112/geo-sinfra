...
<aside class="w-20 lg:w-64 bg-navy-900 text-white flex-col hidden md:flex shadow-2xl z-20 text-left shrink-0 transition-all duration-300">
    <div class="p-4 lg:p-6 flex-1 text-left overflow-y-auto custom-scrollbar">
        ...
        <nav class="space-y-1">
            <a href="{{ route('surveyor.dashboard') }}" 
               class="flex items-center justify-center lg:justify-start gap-3 px-0 lg:px-4 py-3 {{ request()->routeIs('surveyor.dashboard') ? 'bg-gold-500 text-white font-bold shadow-lg shadow-gold-500/20' : 'text-slate-400 hover:text-white hover:bg-white/5' }} rounded-xl text-sm font-semibold transition group text-left" title="Beranda">
            ...
            <a href="{{ route('surveyor.input') }}" 
               class="flex items-center justify-center lg:justify-start gap-3 px-0 lg:px-4 py-3 {{ request()->routeIs('surveyor.input') ? 'bg-gold-500 text-white font-bold shadow-lg shadow-gold-500/20' : 'text-slate-400 hover:text-white hover:bg-white/5' }} rounded-xl text-sm font-semibold transition group text-left" title="Input Data Lapangan">
            ...
            <a href="{{ route('surveyor.history') }}" 
               class="flex items-center justify-center lg:justify-start gap-3 px-0 lg:px-4 py-3 {{ request()->routeIs('surveyor.history') ? 'bg-gold-500 text-white font-bold shadow-lg shadow-gold-500/20' : 'text-slate-400 hover:text-white hover:bg-white/5' }} rounded-xl text-sm font-semibold transition group text-left" title="Riwayat Data Saya">
            ...
            <a href="{{ route('surveyor.map') }}" 
               class="flex items-center justify-center lg:justify-start gap-3 px-0 lg:px-4 py-3 {{ request()->routeIs('surveyor.map') ? 'bg-gold-500 text-white font-bold shadow-lg shadow-gold-500/20' : 'text-slate-400 hover:text-white hover:bg-white/5' }} rounded-xl text-sm font-semibold transition group text-left" title="Peta Sebaran Saya">
...
<nav class="md:hidden fixed bottom-0 left-0 w-full bg-navy-900 border-t border-white/10 z-[9990] flex justify-around items-center px-2 py-3 pb-safe shadow-[0_-10px_30px_rgba(0,0,0,0.3)]">
    <a href="{{ route('surveyor.dashboard') }}" class="flex flex-col items-center gap-1.5 p-2 {{ request()->routeIs('surveyor.dashboard') ? 'text-gold-500' : 'text-slate-400 hover:text-white' }} transition-colors">
    ...
    <a href="{{ route('surveyor.laporan') }}" class="flex flex-col items-center gap-1.5 p-2 {{ request()->routeIs('surveyor.laporan') ? 'text-gold-500' : 'text-slate-400 hover:text-white' }} transition-colors">
    ...
    <a href="{{ route('surveyor.input') }}" class="flex flex-col items-center gap-1.5 p-2 {{ request()->routeIs('surveyor.input') ? 'text-gold-500' : 'text-slate-400 hover:text-white' }} transition-colors relative">
