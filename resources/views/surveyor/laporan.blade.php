            ...
            <div class="flex items-center gap-6">
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ route('surveyor.profile') }}" class="text-right group">
                        <p class="text-xs md:text-sm font-black text-navy-900 leading-none uppercase group-hover:text-gold-500 transition-all max-w-[80px] md:max-w-none truncate">{{ auth()->user()->name }}</p>
