                            ...
                            <tbody class="divide-y divide-slate-50">
                                ...
                                <tr class="hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <td class="px-4 py-2">
                                        ...
                                        <span class="inline-flex px-1.5 py-0.5 bg-navy-50 text-navy-600 rounded-md text-[8px] font-black uppercase tracking-widest">{{ $item->jenis_infrastruktur ?? $item->jenis }}</span>
                                    </td>
                                    ...
                                    <td class="px-4 py-2">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div>
                                                <p class="text-[10px] font-black text-navy-900 uppercase tracking-wider">{{ $item->kelurahan ? $item->kelurahan->nama_kelurahan : '-' }}</p>
                                                ...
                                                <div class="inline-flex items-center bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
                                                    @if($item->cnn || $item->analisis)
                                                        <div class="flex items-center gap-1 bg-slate-50 px-2 py-1 border-r border-slate-200">
                                                            ...
                                                            <span class="text-[9px] font-black text-navy-900">{{ $item->analisis ? number_format($item->analisis->skor_dt, 1) : number_format($item->cnn->skor_cnn * 100, 1) }}%</span>
                                                        </div>
                                                    @endif
                                                    @if($item->analisis)
                                                        <div class="flex items-center gap-1 px-2 py-1 bg-gold-50/50">
                                                            <i class="fas fa-brain text-gold-500 text-[8px]"></i>
                                                            <span class="text-[9px] font-black text-gold-600">{{ $item->analisis->label_prioritas }}</span>
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
