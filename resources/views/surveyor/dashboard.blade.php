        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-8 pb-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:-translate-y-1 transition-transform">
                    ...
                    <h3 class="text-3xl font-black text-navy-900">{{ $totalSurvey }} <span class="text-[10px] font-bold text-slate-400">Laporan</span></h3>
                </div>
                ...
                <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:-translate-y-1 transition-transform">
                    ...
                    <h3 class="text-3xl font-black text-navy-900">{{ $waitingValidation }} <span class="text-[10px] font-bold text-slate-400">Objek</span></h3>
                </div>
                ...
                <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:-translate-y-1 transition-transform">
                    ...
                    <h3 class="text-3xl font-black text-navy-900">{{ $verifiedAI }} <span class="text-[10px] font-bold text-slate-400">Selesai</span></h3>
                </div>
                ...
                <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:-translate-y-1 transition-transform">
                    ...
                    <h3 class="text-3xl font-black text-red-600">{{ $totalRejected }} <span class="text-[10px] font-bold text-red-400/50">Tindakan</span></h3>
                </div>
            </div>
