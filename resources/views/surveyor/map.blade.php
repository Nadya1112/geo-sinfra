                ...
                <div id="condition-card" class="bg-[#1e1b4b]/80 backdrop-blur-xl p-2 rounded-[2.5rem] border border-white/10 shadow-2xl min-w-[200px] transition-all duration-300">
                    ...
                    <div id="condition-options" class="hidden mt-2 p-2 flex flex-col gap-1">
                        <button onclick="handleConditionSelect('Semua')" class="w-full px-5 py-3 rounded-2xl text-[9px] font-black uppercase tracking-widest text-gray-300 hover:bg-white/10 transition-all flex items-center justify-between group">
                            ...
                            <span class="text-[9px] font-black text-blue-400 bg-blue-500/10 px-2.5 py-1 rounded-lg border border-blue-400/20 shadow-sm">{{ $dataMap->count() }}</span>
                        </button>
                        <button onclick="handleConditionSelect('Baik')" class="w-full px-5 py-3 rounded-2xl text-[9px] font-black uppercase tracking-widest text-gray-400 hover:bg-emerald-500/10 hover:text-emerald-400 transition-all flex items-center justify-between group">
                            ...
                            <span class="text-[9px] font-black text-emerald-400 bg-white/5 px-2.5 py-1 rounded-lg border border-emerald-400/20 shadow-sm">{{ $dataMap->where('kondisi', 'Baik')->count() }}</span>
                        </button>
                        <button onclick="handleConditionSelect('Rusak Ringan')" class="w-full px-5 py-3 rounded-2xl text-[9px] font-black uppercase tracking-widest text-gray-400 hover:bg-amber-500/10 hover:text-amber-400 transition-all flex items-center justify-between group">
                            ...
                            <span class="text-[9px] font-black text-amber-400 bg-white/5 px-2.5 py-1 rounded-lg border border-amber-400/20 shadow-sm">{{ $dataMap->where('kondisi', 'Rusak Ringan')->count() }}</span>
                        </button>
                        <button onclick="handleConditionSelect('Rusak Berat')" class="w-full px-5 py-3 rounded-2xl text-[9px] font-black uppercase tracking-widest text-gray-400 hover:bg-red-500/10 hover:text-red-400 transition-all flex items-center justify-between group">
                            ...
                            <span class="text-[9px] font-black text-red-400 bg-white/5 px-2.5 py-1 rounded-lg border border-red-400/20 shadow-sm">{{ $dataMap->where('kondisi', 'Rusak Berat')->count() }}</span>
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-[#1e1b4b]/80 backdrop-blur-xl p-2 rounded-[2.8rem] border border-white/10 shadow-2xl min-w-[220px] transition-all duration-300">
                    ...
                    <div id="category-card" class="p-1">
                        ...
                        <div id="category-options" class="hidden mt-2 p-1 flex flex-col gap-1">
                            ...
                            <button onclick="handleCategorySelect('Sanitasi')" data-type="Sanitasi" class="cat-opt-btn w-full px-5 py-3 rounded-xl text-[8px] font-black uppercase tracking-widest text-gray-400 hover:bg-white/10 transition-all flex items-center justify-between group">
                                <div class="flex items-center gap-3">
                                    <div class="w-3.5 h-3.5 rounded border border-white/20 flex items-center justify-center group-hover:border-blue-400 transition-colors">
                                        <i class="fas fa-check text-[7px] text-blue-400 opacity-0 transition-opacity"></i>
                                    </div>
                            ...
                            <button onclick="handleCategorySelect('Titian')" data-type="Titian" class="cat-opt-btn w-full px-5 py-3 rounded-xl text-[8px] font-black uppercase tracking-widest text-gray-400 hover:bg-white/10 transition-all flex items-center justify-between group">
                                <div class="flex items-center gap-3">
                                    <div class="w-3.5 h-3.5 rounded border border-white/20 flex items-center justify-center group-hover:border-purple-400 transition-colors">
                                ...
                                <div class="w-3.5 h-3.5 rounded bg-purple-500 shadow-lg shadow-purple-500/20"></div>
                            </button>
                            <div class="h-[1px] bg-white/5 my-1"></div>
                            <button onclick="toggleKelurahanPoints()" class="w-full px-5 py-3 rounded-xl text-[8px] font-black uppercase tracking-widest text-gray-400 hover:bg-white/10 transition-all flex items-center justify-between group" id="kel-toggle-btn">
                                <div class="flex items-center gap-3">
                    ...
                    <div id="territory-card" class="p-1">
                        ...
                        <div id="territory-options" class="hidden mt-2 p-1 flex flex-col gap-1 max-h-48 overflow-y-auto custom-scrollbar">
                            ...
                            <button onclick="handleTerritorySelect('{{ $kec->id_kecamatan }}', '{{ $kec->nama_kecamatan }}')" data-id="{{ $kec->id_kecamatan }}" class="territory-opt-btn w-full px-5 py-3 rounded-xl text-[8px] font-black uppercase tracking-widest text-gray-400 hover:bg-white/10 transition-all flex items-center justify-between group">
                                <div class="flex items-center gap-3">
                                    <div class="w-3.5 h-3.5 rounded border border-white/20 flex items-center justify-center group-hover:border-emerald-400 transition-colors">
                                        <i class="fas fa-check text-[7px] text-emerald-400 opacity-0 transition-opacity"></i>
                                    </div>
                                    <span class="truncate max-w-[110px] group-hover:text-white transition-colors">{{ $kec->nama_kecamatan }}</span>
                                </div>
                                <div class="w-3.5 h-3.5 rounded shadow-lg border border-white/10" style="background-color: {{ $kec->warna ?? '#cbd5e1' }}; box-shadow: 0 0 10px {{ ($kec->warna ?? '#cbd5e1') }}40;"></div>
                            </button>
                            @endforeach
                        </div>
                    </div>
    ...
    <script>
        ...
        function handleCategorySelect(type) {
            if (type === 'Semua') {
                ...
                else activeTypes = ['Jalan', 'Sanitasi', 'Titian'];
            } else {
