    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden pb-24 md:pb-0">
        ...
        <div class="flex-1 relative">
            ...
            <div id="mobile-filter-sheet" class="hidden md:!flex md:!translate-y-0 translate-y-full fixed inset-x-0 bottom-0 md:absolute md:top-4 md:bottom-auto md:right-4 z-[2000] pointer-events-auto transition-transform duration-300">
                <div class="bg-white/95 dark:bg-[#1e1b4b]/95 backdrop-blur-xl rounded-t-[2.5rem] md:rounded-2xl border-t md:border border-slate-200 dark:border-white/10 shadow-2xl w-full md:w-48 flex flex-col max-h-[85vh]">
