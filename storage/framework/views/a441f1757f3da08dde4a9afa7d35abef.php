        ...
        <header class="bg-white/80 backdrop-blur-xl border-b border-slate-100 px-8 py-5 flex justify-between items-center z-40 shrink-0">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h2 class="text-xl font-black text-navy-900 leading-none">Detail <?php echo e(ucfirst($inf->jenis) ?? 'Infrastruktur'); ?></h2>
                </div>
            </div>
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="text-right hidden sm:block">
                    ...
                    <?php else: ?>
                        <p class="text-[11px] font-black text-navy-900"><?php echo e(\Carbon\Carbon::parse($inf->updated_at)->translatedFormat('H:i')); ?> WITA</p>
