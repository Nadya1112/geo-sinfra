    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden text-left font-sans">
        ...
        <header class="bg-white/80 dark:bg-[#1e1b4b]/80 backdrop-blur-xl border-b border-slate-100 dark:border-white/10 px-4 pl-20 md:px-8 py-4 flex justify-between items-center z-40 shrink-0 sticky top-0">
            <div class="flex items-center gap-4 min-w-0">
                <a href="<?php echo e(route('tim_teknis.dashboard')); ?>" class="w-10 h-10 flex items-center justify-center bg-white dark:bg-[#1e1b4b] border border-slate-200 dark:border-white/20 text-slate-400 rounded-xl hover:bg-gold-50 hover:text-gold-600 hover:border-gold-200 transition-all shadow-sm hidden md:flex">
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-8 pb-16">
            <div class="max-w-4xl mx-auto">
                ...
                <form action="<?php echo e(route('tim_teknis.profile.update')); ?>" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white dark:bg-[#1e1b4b] rounded-[2.5rem] p-8 border border-slate-100 dark:border-white/10 shadow-sm text-center relative overflow-hidden">
                            ...
                            <h4 class="font-black text-navy-900 dark:text-white text-lg uppercase tracking-wider"><?php echo e(auth()->user()->name); ?></h4>
                            <div class="inline-flex items-center gap-1.5 px-3 py-1 bg-navy-50 border border-navy-100 rounded-lg mt-2">
                                ...
                                <p class="text-xs font-black text-navy-900 dark:text-white uppercase tracking-widest"><?php echo e(auth()->user()->role); ?></p>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\tim_teknis\profile.blade.php ENDPATH**/ ?>