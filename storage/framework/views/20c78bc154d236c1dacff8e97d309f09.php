        ...
        <div class="flex-1 p-8 overflow-y-auto custom-scrollbar text-left">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                ...
                <div class="flex flex-col lg:flex-row items-center gap-3 w-full lg:w-auto">
                    ...
                    <form action="<?php echo e(route('admin.infrastruktur')); ?>" method="GET" class="flex items-center w-full lg:w-[280px] xl:w-[350px]">
                        <select name="show" onchange="this.form.submit()" class="pl-4 pr-8 py-2.5 bg-white border border-slate-100 border-r-0 rounded-l-2xl text-xs font-bold text-navy-900 focus:outline-none focus:ring-4 focus:ring-gold-500/10 focus:border-gold-500 transition-all shadow-sm shrink-0">
                            <option value="10" <?php echo e(request('show') != 'all' ? 'selected' : ''); ?>>10 Data</option>
                    ...
                    <a href="<?php echo e(route('admin.infrastruktur.create')); ?>"
                    ...
                    <a href="<?php echo e(route('admin.infrastruktur.export')); ?>"
            ...
            <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden mb-10">
                        ...
                        <tbody class="divide-y divide-slate-50">
                            ...
                            <tr class="hover:bg-slate-50/60 transition-colors">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <span class="text-xs font-black text-slate-400"><?php echo e($nomor); ?></span>
                                </td>
                                ...
                                <td class="px-4 py-3 max-w-[200px]">
                                    ...
                                    <p class="text-xs text-slate-400 mt-1 font-bold">ID: INF-<?php echo e($inf->id_infrastruktur); ?></p>
                                </td>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-start gap-2">
                                        ...
                                        <div>
                                            <p class="text-xs font-black text-navy-900 leading-snug"><?php echo e($inf->nama_kecamatan ?? '-'); ?></p>
                                            <p class="text-xs text-slate-500 font-semibold mt-0.5">Kel. <?php echo e($inf->nama_kelurahan ?? '-'); ?></p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex flex-col gap-1.5 items-center min-w-[130px]">
                                        <div class="flex items-center gap-2 w-full">
                                            ...
                                            <span class="text-xs font-bold <?php echo e($cnnLabel ? $cnnColor : 'text-slate-400'); ?> leading-none">
                                                <?php echo e($cnn ? round($cnn->skor_cnn * 100).'%' : '—'); ?>

                                                <span class="text-slate-400">(<?php echo e($cnn->label_kondisi ?? 'Scanning'); ?>)</span>
                                            </span>
                                        </div>
                                        <div class="flex items-center gap-2 w-full">
                                            ...
                                            <span class="text-xs font-bold text-slate-500 leading-none">
                                                Skor: <span class="text-navy-900 font-black"><?php echo e($dt->skor_dt ?? '0'); ?></span>/100
                                            </span>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-3 text-center">
                                    <span class="inline-block px-3 py-1.5 rounded-xl text-xs font-black tracking-wider uppercase <?php echo e($labelColor); ?>">
                                        <?php echo e($labelAkhir); ?>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-1.5 w-max mx-auto">
                                        ...
                                        <?php else: ?>
                                            <form action="<?php echo e(route('admin.infrastruktur.verifikasi', $inf->id_infrastruktur)); ?>" method="POST" class="inline-block">
                                                <?php echo csrf_field(); ?>
                                        ...
                                        <a href="<?php echo e(route('admin.infrastruktur.show', $inf->id_infrastruktur)); ?>" title="Lihat Detail"
                                        ...
                                        <a href="<?php echo e(route('admin.infrastruktur.edit', $inf->id_infrastruktur)); ?>" title="Edit Data"
                                        ...
                                        <a href="<?php echo e(route('admin.infrastruktur.pdf', $inf->id_infrastruktur)); ?>" target="_blank" title="Cetak PDF"
                                        ...
                                        <form action="<?php echo e(route('admin.infrastruktur.destroy', $inf->id_infrastruktur)); ?>" method="POST" class="inline-block">
                                            <?php echo csrf_field(); ?>
                ...
                <?php if(request('show') != 'all' && isset($infrastruktur) && $infrastruktur instanceof \Illuminate\Pagination\LengthAwarePaginator): ?>
                    <div class="px-4 py-3 border-t border-slate-50">
                        <?php echo e($infrastruktur->links()); ?>
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\admin\infrastruktur.blade.php ENDPATH**/ ?>