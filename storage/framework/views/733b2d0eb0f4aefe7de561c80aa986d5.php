    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto custom-scrollbar">
        ...
        <header class="bg-white border-b border-slate-100 px-8 py-5 flex justify-between items-center z-10 sticky top-0">
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('kabid.validasi')); ?>" class="w-10 h-10 flex items-center justify-center bg-slate-50 text-slate-400 rounded-xl hover:bg-gold-50 hover:text-gold-500 transition-all border border-slate-100">
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-navy-900 rounded-[2.5rem] p-8 text-white shadow-xl relative overflow-hidden">
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="relative">
                                ...
                                <p class="text-[8px] font-bold text-slate-400 mt-2 italic text-right"><?php echo e($infrastruktur->cnn->label_kondisi ?? 'Scanning visual...'); ?></p>
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <p class="text-[8px] font-bold <?php echo e(($infrastruktur->analisis->label_prioritas ?? '') == 'Rusak Berat' ? 'text-rose-400' : 'text-[#059669]'); ?> mt-2 italic text-right">
                            ...
                            <div class="pt-6 border-t border-white/10">
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <span class="px-3 py-1 bg-white/5 border border-white/10 rounded-lg text-[8px] font-black uppercase tracking-widest <?php echo e($infrastruktur->status_verifikasi == 'Verified' ? 'text-[#059669]' : 'text-amber-400'); ?>">
                    ...
                    <div class="bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm">
                        ...
                        <div class="flex flex-col gap-3">
                            <form action="<?php echo e(route('kabid.validasi.proses', $infrastruktur->id_infrastruktur)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="bg-white rounded-[2.5rem] p-6 border border-slate-100 shadow-sm relative overflow-hidden">
                        ...
                        <form action="<?php echo e(route('kabid.perbaikan.update', $infrastruktur->id_infrastruktur)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="space-y-3">
                                <label class="flex items-center justify-between p-3 rounded-2xl border cursor-pointer transition-all <?php echo e($infrastruktur->status_perbaikan == 'Menunggu' ? 'border-amber-500 bg-amber-50' : 'border-slate-200 hover:bg-slate-50'); ?>">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-[11px] font-black <?php echo e($infrastruktur->status_perbaikan == 'Menunggu' ? 'text-amber-700' : 'text-slate-600'); ?> uppercase tracking-wider">Menunggu</p>
                                ...
                                <label class="flex items-center justify-between p-3 rounded-2xl border cursor-pointer transition-all <?php echo e($infrastruktur->status_perbaikan == 'Proses Perbaikan' ? 'border-blue-500 bg-blue-50' : 'border-slate-200 hover:bg-slate-50'); ?>">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-[11px] font-black <?php echo e($infrastruktur->status_perbaikan == 'Proses Perbaikan' ? 'text-blue-700' : 'text-slate-600'); ?> uppercase tracking-wider">Dalam Perbaikan</p>
                                ...
                                <label class="flex items-center justify-between p-3 rounded-2xl border cursor-pointer transition-all <?php echo e($infrastruktur->status_perbaikan == 'Selesai' ? 'border-emerald-500 bg-emerald-50' : 'border-slate-200 hover:bg-slate-50'); ?>">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-[11px] font-black <?php echo e($infrastruktur->status_perbaikan == 'Selesai' ? 'text-emerald-700' : 'text-slate-600'); ?> uppercase tracking-wider">Selesai</p>
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm">
                        <div class="flex justify-between items-start mb-8">
                            <div>
                                <p class="text-[10px] font-black text-gold-500 uppercase tracking-widest mb-1"><?php echo e($infrastruktur->jenis_infrastruktur); ?></p>
                                <h3 class="text-2xl font-black text-navy-900"><?php echo e($infrastruktur->nama_infrastruktur); ?></h3>
                            </div>
                            <div class="text-right">
                                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">Diinput Pada</p>
                                <p class="text-xs font-black text-navy-900"><?php echo e($infrastruktur->created_at->translatedFormat('d F Y, H:i')); ?> WITA</p>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-bold text-navy-900"><?php echo e($infrastruktur->kelurahan->kecamatan->nama_kecamatan ?? '-'); ?></p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-4">
                                    <div class="w-10 h-10 rounded-2xl bg-navy-50 flex items-center justify-center text-navy-500 border border-navy-100 flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-bold text-navy-900"><?php echo e($infrastruktur->kelurahan->nama_kelurahan ?? '-'); ?></p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-4">
                                    <div class="w-10 h-10 rounded-2xl bg-navy-50 flex items-center justify-center text-navy-500 border border-navy-100 flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-bold text-navy-900"><?php echo e($infrastruktur->user->name ?? '-'); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="space-y-4">
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs font-bold text-navy-900"><?php echo e($infrastruktur->latitude); ?>, <?php echo e($infrastruktur->longitude); ?></p>
                                    </div>
                                </div>
