    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        <header class="bg-white  border-b border-navy-50 sticky top-0 px-4 pl-20 md:px-8 py-4 flex justify-between items-center z-10 shadow-sm relative">
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('surveyor.dashboard')); ?>" class="hidden md:flex w-10 h-10  items-center justify-center bg-navy-50  text-navy-400 rounded-xl hover:bg-gold-50 hover:text-gold-600 transition-all border border-navy-100">
            ...
            <div class="flex items-center gap-3 md:gap-6">
                <div class="text-right">
                    ...
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-tighter hidden md:block"><?php echo e(now()->translatedFormat('l, d F Y')); ?></p>
                </div>
                <div class="h-6 md:h-8 w-[1px] bg-navy-100"></div>
                <a href="<?php echo e(route('surveyor.profile')); ?>" class="flex items-center gap-2 md:gap-3 group">
                    <div class="text-right">
                        <p class="text-sm font-black text-navy-900 leading-none uppercase group-hover:text-gold-500 transition-all max-w-[200px] truncate hidden md:block"><?php echo e(auth()->user()->name); ?></p>
        ...
        <div class="flex-1 relative">
            ...
            <div class="absolute bottom-28 md:bottom-6 right-4 z-[2000] pointer-events-auto">
