        ...
        <header class="bg-white/85  backdrop-blur-xl border-b border-slate-100  sticky top-0 px-4 pl-20 md:px-8 py-4 flex justify-between items-center z-40 text-left">
            ...
            <div class="flex items-center gap-3 md:gap-6">
                <div class="text-right">
                    ...
                    <p class="text-[9px] font-bold text-slate-400 uppercase tracking-tighter hidden md:block"><?php echo e(now()->translatedFormat('l, d F Y')); ?></p>
                </div>
                <div class="h-6 md:h-8 w-[1px] bg-slate-200"></div>
                <div class="flex items-center gap-2 md:gap-3">
                    <a href="<?php echo e(route('surveyor.profile')); ?>" class="text-right group">
                        <p class="text-xs md:text-sm font-black text-navy-900 leading-none uppercase group-hover:text-gold-500 transition-all max-w-[200px] truncate hidden md:block"><?php echo e(auth()->user()->name); ?></p>
                        <p class="text-[8px] md:text-xs font-bold text-emerald-500 uppercase md:mt-0.5">Online</p>
                    </a>
                    <a href="<?php echo e(route('surveyor.profile')); ?>" class="w-8 h-8 md:w-10 md:h-10 bg-navy-900 rounded-xl flex items-center justify-center text-gold-500 border border-white/10 overflow-hidden hover:shadow-lg hover:shadow-navy-950/20 transition-all shadow-md shrink-0">
            ...
            <div class="max-w-7xl mx-auto space-y-6">
                ...
                <div class="bg-white  p-5 rounded-[2rem] shadow-sm border border-slate-100  flex flex-col md:flex-row gap-4 items-center justify-between mb-4">
                    <form method="GET" action="<?php echo e(route('surveyor.laporan')); ?>" class="flex flex-col md:flex-row gap-3 w-full">
                        ...
                        <a href="<?php echo e(route('surveyor.laporan')); ?>" class="px-5 py-2.5 bg-red-50 text-red-600 font-bold text-xs uppercase tracking-widest rounded-xl hover:bg-red-100 transition-all text-center flex items-center justify-center shrink-0">
                            Reset
                        </a>
                        <?php endif; ?>
                                ...
                                <tr class="hover:bg-slate-50   transition-colors group">
                                    ...
                                    <td class="px-6 py-4 min-w-[250px]">
                                        ...
                                        <?php if($laporan->label_ai): ?>
                                            ...
                                            ?>
                                            <div class="inline-flex items-center gap-1.5 px-2 py-1 mb-3 rounded border <?php echo e($aiColor); ?> text-xs font-bold tracking-wider">
