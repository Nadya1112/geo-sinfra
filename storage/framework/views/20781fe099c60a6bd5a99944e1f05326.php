                ...
                <form action="<?php echo e(route('admin.users.update', $user->id)); ?>" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="pt-10 flex gap-3">
                            ...
                            <a href="<?php echo e(route('admin.users')); ?>" class="flex-1 bg-slate-100 text-slate-500 text-xs px-4 py-3 rounded-2xl font-bold hover:bg-slate-200 transition text-center flex items-center justify-center gap-2 tracking-widest uppercase">
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\admin\edit-user.blade.php ENDPATH**/ ?>