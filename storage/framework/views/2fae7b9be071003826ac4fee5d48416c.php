            ...
            <div class="w-full max-w-md">
                ...
                <?php if(session('demo_otp')): ?>
                    <div class="mb-6 p-5 bg-gold-50 border border-gold-200 text-gold-700 text-sm rounded-xl shadow-inner text-center">
                        ...
                        <p>Kode OTP Anda adalah: <span class="text-2xl font-black text-navy-900 tracking-widest block mt-2"><?php echo e(session('demo_otp')); ?></span></p>
                    </div>
                <?php endif; ?>

                <form action="<?php echo e(route('register.verifyOtp')); ?>" method="POST" class="space-y-6">
                    <?php echo csrf_field(); ?>
                ...
                <div class="mt-8 pt-6 border-t border-slate-100 text-center">
                    ...
                    <div id="resend-options" class="hidden flex-col gap-3 items-center justify-center">
                        <form action="<?php echo e(route('register.resendOtp')); ?>" method="POST" class="w-full">
                            <?php echo csrf_field(); ?>
                    ...
                    <div class="mt-6">
                        <a href="<?php echo e(route('register')); ?>" class="text-slate-400 hover:text-navy-900 transition-colors text-[10px] uppercase tracking-wider font-bold">
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views/auth/otp.blade.php ENDPATH**/ ?>