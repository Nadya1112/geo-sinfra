...
<body class="bg-navy-50 dark:bg-navy-950 text-slate-800 dark:text-slate-200 antialiased flex overflow-hidden h-screen transition-colors duration-300">
    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header class="bg-white/80 backdrop-blur-xl border-b border-slate-100 px-4  md:px-8 py-4 flex justify-between items-center z-40 shrink-0">
            ...
            <div class="flex items-center gap-3 md:gap-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="<?php echo e(route('admin.profile')); ?>" class="w-10 h-10 bg-navy-900 rounded-xl flex items-center justify-center text-gold-500 border border-white/10 overflow-hidden hover:shadow-lg transition-all shadow-md">
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-8 pb-16">
            ...
            <form action="<?php echo e(route('admin.infrastruktur.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="nama_infrastruktur"
                                           value="<?php echo e(old('nama_infrastruktur')); ?>"
                                ...
                                <div>
                                    ...
                                    <select name="jenis"
                                        ...
                                        <option value="jalan" <?php echo e(old('jenis') == 'jalan' ? 'selected' : ''); ?>>Jalan</option>
                                        <option value="titian" <?php echo e(old('jenis') == 'titian' ? 'selected' : ''); ?>>Titian</option>

                                        <option value="jembatan" <?php echo e(old('jenis') == 'jembatan' ? 'selected' : ''); ?>>Jembatan</option>
                                    </select>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <select name="id_kelurahan"
                                        ...
                                        <?php $__currentLoopData = $semuaKelurahan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($kel->id_kelurahan); ?>" <?php echo e(old('id_kelurahan') == $kel->id_kelurahan ? 'selected' : ''); ?>>
                        ...
                        <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-8">
                            ...
                            <div>
                                ...
                                <textarea name="kondisi" id="kondisi-textarea" rows="3"
                                    ...
                                    required><?php echo e(old('kondisi')); ?></textarea>
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\admin\create-infrastruktur.blade.php ENDPATH**/ ?>