    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        <header class="bg-white dark:bg-[#1e1b4b] border-b border-navy-50 px-8 py-5 flex justify-between items-center z-10 shadow-sm relative">
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('surveyor.dashboard')); ?>" class="w-10 h-10 flex items-center justify-center bg-navy-50 dark:bg-navy-900 text-navy-400 rounded-xl hover:bg-gold-50 hover:text-gold-600 transition-all border border-navy-100">
