    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden text-left font-sans">
        <header class="bg-white/85 dark:bg-navy-950/80 backdrop-blur-xl border-b border-slate-100 dark:border-white/5 px-4  md:px-8 py-4 flex justify-between items-center z-40 text-left transition-colors duration-300">
            <div class="flex items-center gap-4 text-left">
                <a href="<?php echo e(route('admin.wilayah')); ?>" class="hidden md:flex w-10 h-10 bg-white border border-slate-100 rounded-xl flex items-center justify-center text-slate-400 hover:text-gold-500 hover:border-gold-500/20 hover:shadow-lg hover:shadow-gold-500/5 transition-all group">
        ...
        <div class="flex-1 p-8 overflow-y-auto custom-scrollbar text-left">
            ...
            <div class="max-w-3xl bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-sm mx-auto text-left">
                <form action="<?php echo e(route('admin.wilayah.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="relative">
                                <select name="id_kecamatan" class="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-semibold focus:ring-4 focus:ring-gold-500/10 focus:border-gold-500 outline-none appearance-none" required>
                                    ...
                                    <?php $__currentLoopData = $semuaKecamatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($kec->id_kecamatan); ?>" <?php echo e(old('id_kecamatan') == $kec->id_kecamatan ? 'selected' : ''); ?>>
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_kelurahan" value="<?php echo e(old('nama_kelurahan')); ?>" placeholder="Contoh: Antasan Besar" class="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-semibold focus:ring-4 focus:ring-gold-500/10 focus:border-gold-500 outline-none transition-all" required>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="geometri" rows="5" placeholder='{"type": "Polygon", "coordinates": [...]}' class="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-2xl text-xs font-mono focus:ring-4 focus:ring-gold-500/10 focus:border-gold-500 outline-none transition-all"><?php echo e(old('geometri')); ?></textarea>
                        ...
                        <div class="pt-8 flex gap-3">
                            ...
                            <a href="<?php echo e(route('admin.wilayah')); ?>" class="flex-1 bg-slate-100 text-slate-500 text-xs px-4 py-3 rounded-2xl font-bold hover:bg-slate-200 transition text-center flex items-center justify-center gap-2 tracking-widest uppercase">
                                Batal
                            </a>
                        </div>
                    </div>
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\admin\create-wilayah.blade.php ENDPATH**/ ?>