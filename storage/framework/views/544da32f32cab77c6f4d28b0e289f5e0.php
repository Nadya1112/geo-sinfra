        ...
        <div class="p-4 md:p-6 space-y-4 md:space-y-6">
                ...
                <div class="relative z-10 flex items-center justify-between gap-3">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-rose-100 text-xs md:text-sm font-medium">AI mendeteksi <strong class="text-white"><?php echo e($totalRusakBerat); ?> infrastruktur</strong> kondisi kritis. Segera tinjau!</p>
                        </div>
                    </div>
                    <a href="<?php echo e(route('tim_teknis.laporan')); ?>?kondisi=Berat" class="flex-shrink-0 px-3 py-2 md:px-6 md:py-4 bg-white text-rose-600 rounded-xl md:rounded-2xl text-[10px] md:text-xs font-black uppercase tracking-widest hover:bg-rose-50 transition-colors shadow-lg flex items-center gap-1.5">
            ...
            <div class="relative bg-navy-900 rounded-2xl md:rounded-3xl p-5 md:p-8 overflow-hidden shadow-2xl shadow-navy-900/20">
                ...
                <div class="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                    <div>
                        <h1 class="text-lg md:text-2xl font-black text-white mb-1">Selamat Datang, <?php echo e(auth()->user()->name); ?></h1>
                    ...
                    <div class="bg-white/5 backdrop-blur-md rounded-2xl p-3 md:p-5 border border-white/10 hover:bg-white/10 transition-all border-l-gold-400/50 border-l-4">
                        <div class="flex md:flex-col gap-3 md:gap-2">
                            ...
                            <div>
                                ...
                                <h3 class="text-xl md:text-3xl font-black text-white leading-none"><?php echo e($totalInfrastruktur ?? 0); ?></h3>
                    ...
                    <div class="bg-white/5 backdrop-blur-md rounded-2xl p-3 md:p-5 border border-white/10 hover:bg-white/10 transition-all border-l-emerald-400/50 border-l-4">
                        <div class="flex md:flex-col gap-3 md:gap-2">
                            ...
                            <div>
                                ...
                                <h3 class="text-xl md:text-3xl font-black text-white leading-none"><?php echo e($totalBaik ?? 0); ?></h3>
                    ...
                    <div class="bg-white/5 backdrop-blur-md rounded-2xl p-3 md:p-5 border border-white/10 hover:bg-white/10 transition-all border-l-amber-400/50 border-l-4">
                        <div class="flex md:flex-col gap-3 md:gap-2">
                            ...
                            <div>
                                ...
                                <h3 class="text-xl md:text-3xl font-black text-white leading-none"><?php echo e($totalRusakSedang ?? 0); ?></h3>
                    ...
                    <div class="bg-white/5 backdrop-blur-md rounded-2xl p-3 md:p-5 border border-white/10 hover:bg-white/10 transition-all border-l-rose-400/50 border-l-4">
                        <div class="flex md:flex-col gap-3 md:gap-2">
                            ...
                            <div>
                                ...
                                <h3 class="text-xl md:text-3xl font-black text-white leading-none"><?php echo e($totalRusakBerat ?? 0); ?></h3>
                    ...
                    <div class="bg-white/5 backdrop-blur-md rounded-2xl p-3 md:p-5 border border-white/10 hover:bg-white/10 transition-all border-l-blue-300/50 border-l-4">
                        <div class="flex md:flex-col gap-3 md:gap-2">
                            ...
                            <div>
                                ...
                                <h3 class="text-xl md:text-3xl font-black text-white leading-none"><?php echo e($totalPending ?? 0); ?></h3>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5">
                <a href="<?php echo e(route('tim_teknis.monitoring')); ?>" class="bg-white dark:bg-[#1e1b4b] p-4 md:p-8 rounded-2xl md:rounded-[2.5rem] border border-slate-100 dark:border-white/10 shadow-sm hover:shadow-xl hover:-translate-y-1 md:hover:-translate-y-2 transition-all group relative overflow-hidden">
                ...
                <a href="<?php echo e(route('tim_teknis.validasi')); ?>" class="bg-white dark:bg-[#1e1b4b] p-4 md:p-8 rounded-2xl md:rounded-[2.5rem] border border-slate-100 dark:border-white/10 shadow-sm hover:shadow-xl hover:-translate-y-1 md:hover:-translate-y-2 transition-all group relative overflow-hidden">
                ...
                <a href="<?php echo e(route('tim_teknis.prioritas')); ?>" class="bg-white dark:bg-[#1e1b4b] p-4 md:p-8 rounded-2xl md:rounded-[2.5rem] border border-slate-100 dark:border-white/10 shadow-sm hover:shadow-xl hover:-translate-y-1 md:hover:-translate-y-2 transition-all group relative overflow-hidden">
                ...
                <a href="<?php echo e(route('tim_teknis.laporan')); ?>" class="bg-white dark:bg-[#1e1b4b] p-4 md:p-8 rounded-2xl md:rounded-[2.5rem] border border-slate-100 dark:border-white/10 shadow-sm hover:shadow-xl hover:-translate-y-1 md:hover:-translate-y-2 transition-all group relative overflow-hidden">
                    <div class="absolute -right-6 -top-6 w-24 h-24 bg-gold-50 rounded-full group-hover:scale-150 transition-transform duration-700"></div>
                    <div class="relative z-10 flex flex-col h-full justify-between gap-3 md:gap-6">
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\tim_teknis\dashboard.blade.php ENDPATH**/ ?>