    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header class="bg-white/80  backdrop-blur-xl border-b border-slate-100  sticky top-0 px-4 pl-16 md:px-8 py-4 flex justify-between items-center z-40 shrink-0">
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('surveyor.dashboard')); ?>" class="hidden md:flex w-10 h-10  items-center justify-center bg-white  text-slate-400 rounded-xl hover:bg-gold-50 hover:text-gold-600 transition-all border border-slate-200  hover:border-gold-200">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="flex items-center gap-3">
                    <div class="text-right">
                        <p class="text-sm font-black text-navy-900  leading-none uppercase max-w-[100px] sm:max-w-[150px] md:max-w-[300px] truncate"><?php echo e(auth()->user()->name); ?></p>
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-4 md:p-8 pb-16">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="flex justify-between items-end mb-6 flex-col md:flex-row gap-4">
                    ...
                    <form action="<?php echo e(route('surveyor.history')); ?>" method="GET" class="flex gap-2 w-full md:w-auto mt-3 md:mt-0">
                        <select name="status" onchange="this.form.submit()" class="w-full md:w-40 bg-white border border-slate-200 rounded-xl px-4 py-3 text-xs font-black text-navy-900 shadow-sm focus:outline-none focus:ring-4 focus:ring-gold-500/10 focus:border-gold-500 transition-all cursor-pointer">
                            ...
                            <option value="Menunggu Validasi" <?php echo e(request('status') == 'Menunggu Validasi' ? 'selected' : ''); ?>>Menunggu Validasi</option>
                            <option value="Terverifikasi AI" <?php echo e(request('status') == 'Terverifikasi AI' ? 'selected' : ''); ?>>Terverifikasi AI</option>
                            ...
                            <tbody class="divide-y divide-slate-50">
                                ...
                                <tr class="hover:bg-slate-50   transition-colors">
                                    ...
                                    <td class="px-4 py-2">
                                        ...
                                        <span class="inline-flex px-1.5 py-0.5 bg-navy-50  text-navy-600 rounded-md text-xs font-black uppercase tracking-widest"><?php echo e(ucfirst($item->jenis)); ?></span>
                                    </td>
                                    ...
                                    <td class="px-4 py-2">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div>
                                                <p class="text-xs font-black text-navy-900  uppercase tracking-wider"><?php echo e($item->kelurahan ? $item->kelurahan->nama_kelurahan : '-'); ?></p>
                                    ...
                                    <td class="px-4 py-2 text-center">
                                        <?php if($item->status_validasi == 'Rejected'): ?>
                                            <div class="inline-flex flex-col items-center">
                                                ...
                                                <button onclick="alert('Alasan Penolakan: <?php echo e(addslashes($item->alasan_penolakan)); ?>')" class="text-xs font-bold text-red-500 hover:text-red-700 underline cursor-pointer">Lihat Alasan</button>
                                            </div>
                                                ...
                                                <div class="inline-flex items-center bg-white  rounded-lg border border-slate-200  shadow-sm overflow-hidden">
                                                    <?php if($item->analisis): ?>
                                                        ...
                                                        <div class="flex items-center gap-1.5 px-3 py-1.5 <?php echo e($style['bg']); ?>">
                                                            ...
                                                            <span class="text-xs font-black <?php echo e($style['text']); ?> uppercase tracking-wider"><?php echo e($item->analisis->label_prioritas); ?></span>
                                                        </div>
                                                    <?php else: ?>
                                    ...
                                    <td class="px-4 py-2 text-center">
                                        <div class="flex items-center justify-center gap-1.5">
                                            <a href="<?php echo e(route('surveyor.infrastruktur.edit', $item->id_infrastruktur)); ?>" class="w-7 h-7 flex items-center justify-center bg-white  border border-slate-200  text-slate-400 rounded-md hover:bg-gold-500 hover:text-white hover:border-gold-500 hover:shadow-sm transition-all cursor-pointer" title="Edit Data">
