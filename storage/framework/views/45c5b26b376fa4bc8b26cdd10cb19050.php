...
<body class="antialiased bg-gray-50">
    ...
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <div class="w-full md:w-1/2 bg-white flex flex-col items-center justify-center p-8 md:p-20 relative">
            ...
            <div class="absolute top-10 left-10 md:left-20">
                <a href="<?php echo e(route('login')); ?>" class="text-gray-300 hover:text-blue-600 transition-all text-2xl">
            ...
            <div class="w-full max-w-md">
                ...
                <form id="resetForm" action="<?php echo e(route('password.update')); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="token" value="<?php echo e($token); ?>">

                    <div>
                        <label class="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-2 ml-1">Email Konfirmasi</label>
                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="admin@disperkim.go.id" required 
    ...
    <script>
        // SCRIPT TIMER
        let timeLeft = Math.min(300, Math.floor(<?php echo e($sisaWaktu ?? 300); ?>)); 
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>