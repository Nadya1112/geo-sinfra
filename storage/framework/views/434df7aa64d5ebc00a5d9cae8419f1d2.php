    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto custom-scrollbar bg-slate-50 ">
        ...
        <div class="p-8">
            <div class="max-w-7xl mx-auto">
                ...
                <form id="survey-form" action="<?php echo e(route('surveyor.store', [], false)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="grid grid-cols-1 gap-4 pt-4 border-t border-slate-100 ">
                                        <div class="flex items-center justify-between px-2 mb-2">
                                            <span class="text-xs font-black text-slate-400 uppercase tracking-widest">Tgl Survey: <span class="text-navy-900 "><?php echo e(date('d M Y')); ?></span></span>
        ...
        async function syncOfflineData() {
            ...
            for (let key of draftKeys) {
                try {
                    ...
                    const response = await fetch('<?php echo e(route("surveyor.store", [], false)); ?>', {
                        method: 'POST',
                        body: formData,
                        headers: {
        ...
        form.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (response.ok || response.redirected) {
                    ...
                    .then(() => { window.location.href = "<?php echo e(route('surveyor.history', [], false)); ?>"; });
                } else {
