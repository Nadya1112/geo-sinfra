        ...
        <header class="bg-white/80  backdrop-blur-xl border-b border-slate-100  sticky top-0 px-4 pl-16 md:px-8 py-4 flex justify-between items-center z-40 shrink-0">
            ...
            <div class="flex items-center gap-6">
                <div class="text-right">
                    ...
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-tighter hidden sm:block"><?php echo e(now()->translatedFormat('l, d F Y')); ?></p>
                </div>
                <div class="h-8 w-[1px] bg-slate-100"></div>
                <a href="<?php echo e(route('surveyor.profile')); ?>" class="flex items-center gap-3 group">
                    <div class="text-right">
                        <p class="text-sm font-black text-navy-900 leading-none uppercase group-hover:text-gold-500 transition-colors max-w-[100px] sm:max-w-[150px] md:max-w-[300px] truncate"><?php echo e(auth()->user()->name); ?></p>
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-4 md:p-8 pb-16">
            ...
            <div class="relative bg-navy-900 rounded-[2.5rem] p-10 mb-8 overflow-hidden shadow-xl shadow-navy-900/10">
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    ...
                    <a href="<?php echo e(route('surveyor.input')); ?>" class="shrink-0 px-8 py-4 bg-gold-500 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-gold-600 transition-all shadow-lg shadow-gold-500/20 flex items-center gap-3 group">
            ...
            <?php if($rejectedItems->isNotEmpty()): ?>
            <div class="mb-8 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <?php $__currentLoopData = $rejectedItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rejected): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-red-50 border border-red-200 rounded-3xl p-6 shadow-sm relative overflow-hidden flex flex-col justify-between">
                        ...
                        <div class="relative z-10">
                            <div class="flex justify-between items-start mb-3">
                                <div>
                                    <p class="text-[10px] font-black text-red-400 uppercase tracking-widest mb-1"><?php echo e($rejected->kelurahan->nama_kelurahan ?? '-'); ?>, KEC. <?php echo e($rejected->kelurahan->kecamatan->nama_kecamatan ?? '-'); ?></p>
                                    <h5 class="text-base font-black text-red-900 leading-tight"><?php echo e($rejected->nama_infrastruktur); ?></h5>
                                </div>
                            ...
                            <div class="bg-white/60 p-3 rounded-xl border border-red-100 mb-4">
                                ...
                                <p class="text-sm text-red-900 font-medium italic">"<?php echo e($rejected->alasan_penolakan ?? 'Tidak ada alasan spesifik. Harap periksa kembali foto atau titik koordinat.'); ?>"</p>
                            </div>
                        </div>
                        
                        <div class="relative z-10 mt-auto">
                            <a href="<?php echo e(route('surveyor.infrastruktur.edit', $rejected->id_infrastruktur)); ?>" class="w-full flex items-center justify-center gap-2 px-4 py-3 bg-red-600 text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-red-700 transition-colors shadow-md shadow-red-600/20 active:scale-[0.98]">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                <div class="bg-blue-50  p-6 rounded-3xl border border-blue-100  shadow-sm hover:-translate-y-1 transition-transform">
                    ...
                    <h3 class="text-3xl font-black text-blue-600 "><?php echo e($totalSurvey); ?> <span class="text-xs font-bold text-slate-400">Laporan</span></h3>
                </div>
                ...
                <div class="bg-orange-50  p-6 rounded-3xl border border-orange-100  shadow-sm hover:-translate-y-1 transition-transform">
                    ...
                    <h3 class="text-3xl font-black text-orange-600 "><?php echo e($waitingValidation); ?> <span class="text-xs font-bold text-slate-400">Objek</span></h3>
                </div>
                ...
                <div class="bg-emerald-50  p-6 rounded-3xl border border-emerald-100  shadow-sm hover:-translate-y-1 transition-transform">
                    ...
                    <h3 class="text-3xl font-black text-emerald-600 "><?php echo e($verifiedAI); ?> <span class="text-xs font-bold text-slate-400">Selesai</span></h3>
                </div>
                ...
                <div class="bg-red-50  p-6 rounded-3xl border border-red-100  shadow-sm hover:-translate-y-1 transition-transform">
                    ...
                    <h3 class="text-3xl font-black text-red-600 "><?php echo e($totalRejected); ?> <span class="text-xs font-bold text-red-400/50">Tindakan</span></h3>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                <a href="<?php echo e(route('surveyor.laporan')); ?>" class="block bg-indigo-50  p-6 rounded-3xl border border-indigo-100  shadow-sm hover:border-indigo-500/50 transition-all group hover:-translate-y-1">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-2xl font-black text-indigo-600 "><?php echo e($totalTugas); ?></h3>
                        </div>
                    </div>
                </a>
                
                <a href="<?php echo e(route('surveyor.laporan', ['status' => 'Menunggu'])); ?>" class="block bg-orange-50  p-6 rounded-3xl border border-orange-100  shadow-sm hover:border-orange-500/50 transition-all group hover:-translate-y-1">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-2xl font-black text-orange-600 "><?php echo e($tugasMenunggu); ?></h3>
                        </div>
                    </div>
                </a>
                
                <a href="<?php echo e(route('surveyor.laporan', ['status' => 'Selesai'])); ?>" class="block bg-emerald-50  p-6 rounded-3xl border border-emerald-100  shadow-sm hover:border-emerald-500/50 transition-all group hover:-translate-y-1">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-2xl font-black text-emerald-600 "><?php echo e($tugasSelesai); ?></h3>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white  rounded-[2.5rem] p-8 border border-slate-100  shadow-sm">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <a href="<?php echo e(route('surveyor.history')); ?>" class="text-xs font-black text-gold-500 uppercase tracking-widest hover:text-gold-600 transition-colors">Semua Riwayat</a>
                        </div>
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center gap-4 p-3 hover:bg-slate-50   rounded-2xl border border-transparent hover:border-slate-100  transition-all group cursor-pointer">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs font-black text-navy-900  truncate uppercase"><?php echo e($upload->nama_infrastruktur); ?></p>
                                    <p class="text-xs text-slate-400 font-bold uppercase"><?php echo e($upload->created_at->diffForHumans()); ?></p>
                                </div>
                ...
                <form action="<?php echo e(route('surveyor.territory.update')); ?>" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                        ...
                        <label class="relative flex items-center gap-3 p-4 bg-slate-50  rounded-2xl border border-slate-100  cursor-pointer hover:bg-gold-50 hover:border-gold-200 transition-all group">
                            ...
                            <span class="text-xs font-bold text-slate-600  group-hover:text-navy-900  uppercase"><?php echo e($kec->nama_kecamatan); ?></span>
                        </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
