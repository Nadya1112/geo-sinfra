    ...
    <div class="p-6 flex-1 text-left">
        ...
        <nav class="space-y-1">
            ...
            <a href="<?php echo e(route('kabid.profile')); ?>" 
               class="flex items-center gap-3 px-4 py-3 <?php echo e(request()->routeIs('kabid.profile') ? 'bg-indigo-600 text-white font-bold shadow-lg shadow-indigo-900/20' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?> rounded-xl text-sm font-semibold transition group text-left">
                <i class="fas fa-user-circle <?php echo e(request()->routeIs('kabid.profile') ? '' : 'group-hover:text-indigo-400'); ?>"></i> 
                Profil Saya
            </a>
        </nav>
    </div>
