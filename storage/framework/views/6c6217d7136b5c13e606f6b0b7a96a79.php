        ...
        <nav class="space-y-1">
            <a href="<?php echo e(route('kabid.dashboard')); ?>" 
               class="flex items-center gap-3 px-4 py-3 <?php echo e(request()->routeIs('kabid.dashboard') ? 'bg-indigo-600 text-white font-bold shadow-lg shadow-indigo-900/20' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?> rounded-xl text-sm font-semibold transition group text-left">
                <i class="fas fa-th-large <?php echo e(request()->routeIs('kabid.dashboard') ? '' : 'group-hover:text-indigo-400'); ?>"></i> 
                Dashboard
            </a>

            <a href="<?php echo e(route('kabid.monitoring')); ?>" 
               class="flex items-center gap-3 px-4 py-3 <?php echo e(request()->routeIs('kabid.monitoring') ? 'bg-indigo-600 text-white font-bold shadow-lg shadow-indigo-900/20' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?> rounded-xl text-sm font-semibold transition group text-left">
                <i class="fas fa-map-marked-alt <?php echo e(request()->routeIs('kabid.monitoring') ? '' : 'group-hover:text-indigo-400'); ?>"></i> 
                Monitoring Peta
            </a>

            <a href="<?php echo e(route('kabid.verifikasi')); ?>" 
               class="flex items-center gap-3 px-4 py-3 <?php echo e(request()->routeIs('kabid.verifikasi') ? 'bg-indigo-600 text-white font-bold shadow-lg shadow-indigo-900/20' : 'text-gray-400 hover:text-white hover:bg-white/5'); ?> rounded-xl text-sm font-semibold transition group text-left">
                <i class="fas fa-file-circle-check <?php echo e(request()->routeIs('kabid.verifikasi') ? '' : 'group-hover:text-indigo-400'); ?>"></i> 
                Verifikasi Usulan
            </a>
