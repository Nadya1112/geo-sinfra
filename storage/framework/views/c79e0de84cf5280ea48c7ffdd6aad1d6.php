            ...
            <div class="max-w-4xl bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-sm mx-auto">
                ...
                <form action="<?php echo e(route('admin.infrastruktur.update', $inf->id_infrastruktur)); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <select name="jenis_infrastruktur" class="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-semibold outline-none focus:border-blue-500">
                                    <?php $jenisAktif = strtolower($inf->jenis ?? $inf->jenis_infrastruktur); ?>
                                    <option value="Jalan" <?php echo e($jenisAktif == 'jalan' ? 'selected' : ''); ?>>Jalan</option>
                                    <option value="Sanitasi" <?php echo e($jenisAktif == 'sanitasi' ? 'selected' : ''); ?>>Sanitasi</option>
                                    <option value="Titian" <?php echo e($jenisAktif == 'titian' ? 'selected' : ''); ?>>Titian</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6 pt-6 border-t border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <input type="text" name="latitude" id="lat-input" value="<?php echo e($inf->latitude); ?>" class="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-semibold outline-none focus:border-blue-500 transition-all">
                            </div>
                            <div>
                                <label class="block text-[10px] font-black text-[#1e1b4b] uppercase mb-2">Longitude <span class="text-red-500">*</span></label>
                                <input type="text" name="longitude" id="lng-input" value="<?php echo e($inf->longitude); ?>" class="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-semibold outline-none focus:border-blue-500 transition-all">
                            </div>
                        </div>
                    ...
                    <div class="space-y-6 pt-6 border-t border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <input type="hidden" name="kondisi" value="<?php echo e($inf->kondisi); ?>">
                                <div class="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-2xl flex items-center gap-3 cursor-not-allowed">
                                    <span class="px-2.5 py-1 rounded-lg text-[10px] font-black tracking-widest border <?php echo e($inf->kondisi == 'Baik' ? 'bg-green-50 text-green-600 border-green-200' : ($inf->kondisi == 'Rusak Ringan' ? 'bg-yellow-50 text-yellow-600 border-yellow-200' : 'bg-red-50 text-red-600 border-red-200')); ?>">
                    ...
                    <div class="flex gap-4 pt-8 mt-4 border-t border-gray-100">
                        ...
                        <a href="<?php echo e(route('admin.infrastruktur')); ?>" class="flex-1 bg-gray-100 text-gray-500 py-4 rounded-2xl font-bold hover:bg-gray-200 transition text-center leading-[1.2rem] tracking-widest text-sm flex items-center justify-center uppercase">Batal</a>
                    </div>
                </form>
            </div>
        </div>
