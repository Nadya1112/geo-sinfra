            ...
            <div class="max-w-7xl mx-auto space-y-6">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-2">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <a href="<?php echo e(route('admin.laporan-warga.pdf')); ?>" target="_blank"
                ...
                <div class="bg-white p-5 rounded-[2rem] shadow-sm border border-slate-100 flex flex-col md:flex-row gap-4 items-center justify-between mb-4">
                    <form method="GET" action="<?php echo e(route('admin.laporan-warga')); ?>" class="flex flex-col md:flex-row gap-3 w-full">
                        ...
                        <a href="<?php echo e(route('admin.laporan-warga')); ?>" class="px-5 py-2.5 bg-red-50 text-red-600 font-bold text-[10px] uppercase tracking-widest rounded-xl hover:bg-red-100 transition-all text-center flex items-center justify-center shrink-0">
                            Reset
                        </a>
                        <?php endif; ?>
                        ...
                        <table class="w-full text-left text-sm whitespace-nowrap md:whitespace-normal">
                            ...
                            <tbody class="divide-y divide-slate-100">
                                ...
                                <tr class="hover:bg-slate-50/80 transition-colors group">
                                    ...
                                    <td class="px-6 py-4">
                                        <form action="<?php echo e(route('admin.laporan-warga.status', $laporan->id)); ?>" method="POST" class="inline-block relative w-36">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <a href="<?php echo e(route('admin.laporan-warga.convert', $laporan->id)); ?>" title="Tinjau & Tindak Lanjuti" class="w-8 h-8 rounded-lg bg-emerald-50 text-emerald-600 hover:bg-emerald-500 hover:text-white flex items-center justify-center transition-all opacity-50 group-hover:opacity-100">
                                                <i class="fas fa-eye text-xs"></i>
                                            </a>
                                            <?php else: ?>
                                            <a href="<?php echo e(route('admin.infrastruktur.show', $laporan->id_infrastruktur)); ?>" title="Lihat Infrastruktur" class="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-500 hover:text-white flex items-center justify-center transition-all opacity-50 group-hover:opacity-100">
                                                <i class="fas fa-eye text-xs"></i>
                                            </a>
                                            <?php endif; ?>
