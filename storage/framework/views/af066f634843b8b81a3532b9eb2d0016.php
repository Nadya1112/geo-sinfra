...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .hero-premium {
            position: relative;
            background-image: url('<?php echo e(asset('gambar_landing_page.jpeg')); ?>');
...
<body class="antialiased font-sans bg-slate-50 text-slate-800">
        ...
        <div class="max-w-7xl mx-auto px-6 md:px-8 w-full flex justify-between items-center">
            ...
            <div class="flex items-center">
                <a href="#" class="h-16 flex items-center gap-2.5">
                    <img src="<?php echo e(asset('logo_geo-sinfra.png')); ?>" class="h-9 md:h-10 w-auto object-contain drop-shadow-md transition-all duration-300" alt="Logo Geo-Sinfra">
            ...
            <div class="flex items-center gap-2 md:gap-4">
                ...
                <a href="<?php echo e(url('/login')); ?>" class="bg-navy-900 text-gold-500 hover:bg-gold-500 hover:text-white px-3 md:px-4 py-2 rounded-lg text-[10px] md:text-xs font-bold transition-all shadow-sm hidden md:flex items-center gap-2 uppercase tracking-wider">
                ...
                <div class="relative md:hidden ml-1">
                    ...
                    <div id="mobile-dropdown" class="hidden absolute right-0 mt-3 w-48 bg-white rounded-xl shadow-2xl py-2 border border-slate-100 z-[6000]">
                        ...
                        <a href="<?php echo e(url('/login')); ?>" class="flex items-center px-4 py-3 text-xs font-black text-navy-900 hover:bg-slate-50 uppercase tracking-widest">
        ...
        <div class="max-w-7xl mx-auto px-6 md:px-8 w-full relative z-10">
            <div class="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-12">
                ...
                <div class="hidden md:flex justify-center items-center w-56 h-56 lg:w-72 lg:h-72 animate-bounce">
                    <img src="<?php echo e(asset('logo_geo-sinfra.png')); ?>" alt="Logo Geo-Sinfra" class="w-full h-full object-contain drop-shadow-[0_10px_20px_rgba(255,255,255,0.2)]">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 reveal-up">
                ...
                <div class="bg-[#0f0e2c] text-white p-6 rounded-3xl border border-blue-500/50 shadow-2xl hover:border-blue-500 transition-all duration-300 text-center relative overflow-hidden group hover:scale-[1.02]">
                    <div class="relative z-10">
                        ...
                        <p class="text-3xl md:text-4xl font-black text-blue-500 leading-none mb-2"><?php echo e(number_format($stats['total'] ?? 0)); ?></p>
                ...
                <div class="bg-[#0f0e2c] text-white p-6 rounded-3xl border border-emerald-500/50 shadow-2xl hover:border-emerald-500 transition-all duration-300 text-center relative overflow-hidden group hover:scale-[1.02]">
                    <div class="relative z-10">
                        ...
                        <p class="text-3xl md:text-4xl font-black text-emerald-500 leading-none mb-2"><?php echo e(number_format($stats['kecamatan'] ?? 0)); ?></p>
                ...
                <div class="bg-[#0f0e2c] text-white p-6 rounded-3xl border border-red-500/50 shadow-2xl hover:border-red-500 transition-all duration-300 text-center relative overflow-hidden group hover:scale-[1.02]">
                    <div class="relative z-10">
                        ...
                        <p class="text-3xl md:text-4xl font-black text-red-500 leading-none mb-2"><?php echo e(number_format($stats['rusak_berat'] ?? 0)); ?></p>
                ...
                <div class="bg-[#0f0e2c] text-white p-6 rounded-3xl shadow-2xl border border-gold-500/60 text-center relative overflow-hidden group hover:scale-[1.02] hover:border-gold-500 transition-all duration-300">
                    <div class="relative z-10">
                        ...
                        <p class="text-3xl md:text-4xl font-black text-gold-500 leading-none mb-2"><?php echo e($stats['akurasi_ai'] ?? 0); ?>%</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-12 reveal-up">
                ...
                <div class="bg-[#0f0e2c] p-8 rounded-3xl shadow-2xl relative overflow-hidden flex flex-col justify-between text-white border border-white/5">
                    ...
                    <div class="relative z-10 flex items-baseline gap-2">
                        <span class="text-4xl lg:text-5xl font-black text-gold-500"><?php echo e(number_format($topKategoriCount)); ?></span>
                            ...
                            <?php $__currentLoopData = $kondisiWilayah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-white/5 transition-all group border-l-4 border-transparent hover:border-gold-500 cursor-default">
                                    ...
                                    <td class="px-8 py-5 text-center">
                                        <span class="inline-block px-3.5 py-1.5 bg-red-500/20 text-red-400 rounded-full text-xs font-black tracking-wide group-hover:bg-red-500 group-hover:text-white transition-all shadow-sm"><?php echo e($item['rusak_berat']); ?></span>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                            ...
                            <div class="border-t border-white/10 pt-2">
                                ...
                                <label class="flex items-center justify-between p-2 hover:bg-white/5 rounded-lg cursor-pointer transition-all group">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-xs font-bold text-slate-200 uppercase tracking-wider"><?php echo e($wil->nama_kecamatan); ?></span>
                                    </div>
    ...
    <footer class="bg-navy-950 pt-20 pb-10 text-white relative border-t border-white/5">
        <div class="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
                ...
                <div>
                    <div class="mb-6">
                        <img src="<?php echo e(asset('logo_dinas.jpeg')); ?>" alt="Logo Banjarmasin" class="w-40 md:w-56 h-auto drop-shadow-xl rounded-xl" onerror="this.style.display='none'">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-center gap-4">
                            ...
                            <span class="text-sm text-slate-400"><?php echo e(\App\Helpers\SettingHelper::get('instansi_phone', '(0511) 3365592')); ?></span>
                        </li>
                        <li class="flex items-center gap-4">
                            ...
                            <span class="text-sm text-slate-400">
                                ...
                                ?>
                                <a href="https://wa.me/<?php echo e($waLink); ?>" target="_blank" class="hover:text-gold-500 transition-colors" title="Chat WhatsApp">
                                    <?php echo e($waNumber); ?>
    ...
    <div id="modal-lapor" class="hidden fixed inset-0 z-[10000] flex items-center justify-center p-4 sm:p-6 backdrop-blur-xl bg-[#0a091d]/80 transition-all duration-300">
        <div class="bg-[#0f0e2c]/95 backdrop-blur-3xl w-full max-w-2xl rounded-[2.5rem] shadow-2xl border border-white/10 overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div class="p-6 overflow-y-auto custom-scrollbar flex-1">
                <form action="<?php echo e(route('lapor.warga')); ?>" method="POST" enctype="multipart/form-data" id="form-lapor-warga">
                    <?php echo csrf_field(); ?>
    ...
    <?php if(session('success_laporan')): ?>
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
                title: 'Laporan Berhasil!',
                text: "<?php echo e(session('success_laporan')); ?>",
                icon: 'success',
