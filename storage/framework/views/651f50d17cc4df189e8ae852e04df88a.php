...
<body class="antialiased bg-slate-50 font-sans">
    ...
    <div class="flex flex-col md:flex-row h-screen overflow-hidden">
        ...
        <div class="w-full md:w-1/2 bg-premium-mesh flex flex-col items-center justify-center p-12 text-center relative overflow-hidden">
            ...
            <a href="<?php echo e(url('/')); ?>" class="absolute top-6 left-6 z-50 w-12 h-12 bg-white/5 hover:bg-white/15 backdrop-blur-md rounded-2xl border border-white/10 flex items-center justify-center text-white hover:text-gold-500 hover:scale-105 transition-all shadow-xl">
        ...
        <div class="w-full md:w-1/2 bg-white flex flex-col items-center justify-center p-8 md:p-20 overflow-y-auto">
            <div class="w-full max-w-md">
                ...
                <form action="<?php echo e(route('login')); ?>" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-2.5 ml-1">
                            Verifikasi Keamanan: <?php echo e($n1); ?> + <?php echo e($n2); ?> <span class="text-gold-500">*</span>
                        </label>
                    ...
                    <div class="flex items-center justify-between font-bold text-xs uppercase tracking-wider">
                        ...
                        <a href="<?php echo e(route('password.request')); ?>" class="text-gold-500 hover:text-gold-600 transition-colors text-[10px]">Lupa Password?</a>
                    </div>
                </form>
