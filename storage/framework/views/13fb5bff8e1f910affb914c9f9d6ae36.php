                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors group">
                                <td class="px-6 py-3 whitespace-nowrap text-xs font-black text-gray-300">
                                ...
                                <td class="px-6 py-3 min-w-[250px]">
                                    <div class="flex items-center gap-3">
                                        <div class="w-10 h-10 rounded-xl bg-gray-100 overflow-hidden shadow-sm border border-white flex-shrink-0">
                                            <img src="<?php echo e(asset('storage/' . $item->foto_terbaru)); ?>" class="w-full h-full object-cover">
                                        </div>
                                        <div>
                                            <h4 class="text-[13px] font-black text-[#1e1b4b] leading-tight"><?php echo e($item->nama_objek); ?></h4>
                                            <p class="text-[9px] font-bold text-indigo-500 uppercase tracking-tighter mt-0.5"><?php echo e($item->jenis); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-3 whitespace-nowrap">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <p class="text-xs font-black text-[#1e1b4b]"><?php echo e($item->user->name ?? 'Anonim'); ?></p>
                                    </div>
                                </td>
                                <td class="px-6 py-3 whitespace-nowrap">
                                ...
                                <td class="px-6 py-3 whitespace-nowrap">
                                    <div class="flex items-center justify-center gap-2 flex-wrap">
                                        ...
                                        <a href="<?php echo e(route('kabid.infrastruktur.show', $item->id_infrastruktur)); ?>" class="flex items-center gap-1.5 px-3 py-2 bg-indigo-50 text-indigo-600 rounded-xl hover:bg-indigo-600 hover:text-white transition-all border border-indigo-100 shadow-sm" title="Lihat Detail">
                                        ...
                                        <?php if($item->status_verifikasi == 'Pending'): ?>
                                            <form action="<?php echo e(route('kabid.validasi.proses', $item->id_infrastruktur)); ?>" method="POST" class="inline">
                                                <?php echo csrf_field(); ?>
