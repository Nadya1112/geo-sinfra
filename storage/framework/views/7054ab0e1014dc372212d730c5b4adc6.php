    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto p-8 custom-scrollbar">
            ...
            <div class="bg-white dark:bg-[#1e1b4b] rounded-[2rem] p-8 border border-slate-100 dark:border-white/10 shadow-sm mb-8 no-print">
                <form action="<?php echo e(route('tim_teknis.laporan')); ?>" method="GET" class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-wrap md:flex-nowrap gap-6 items-end">
                        ...
                        <div class="w-full md:flex-1 flex gap-2 justify-end">
                            ...
                            <a href="<?php echo e(route('tim_teknis.laporan')); ?>" class="px-4 py-2.5 bg-slate-50 dark:bg-[#0f0e2c] text-slate-400 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-100 hover:text-slate-600 transition-all flex items-center border border-slate-100 dark:border-white/10 shadow-sm" title="Reset Filter">
            ...
            <div class="print-no-style bg-white dark:bg-[#1e1b4b] rounded-[2rem] border border-slate-100 dark:border-white/10 shadow-sm overflow-hidden mt-6">
                ...
                <div class="bg-navy-50/50 px-6 py-4 border-b border-navy-100/50 flex flex-wrap items-center gap-3 no-print">
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('tim_teknis.laporan')); ?>" class="ml-auto text-[10px] font-bold text-red-400 hover:text-red-600 transition-all">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="group hover:bg-slate-50 dark:bg-[#0f0e2c]/50 transition-all">
                            ...
                            <td class="px-6 py-3">
                                ...
                                <span class="text-[9px] text-slate-400 font-bold uppercase"><?php echo e($item->jenis); ?></span>
                            </td>
                            <td class="px-6 py-3">
                                ...
                                <span class="text-[9px] text-slate-400 font-bold uppercase"><?php echo e($item->kelurahan->kecamatan->nama_kecamatan ?? '-'); ?></span>
                            </td>
                            <td class="px-6 py-3">
                                <div class="flex justify-center">
                                    ...
                                    ?>
                                    <span class="px-2.5 py-1 rounded-md text-[8px] font-black uppercase border tracking-widest badge-print <?php echo e($condClass); ?>">
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views/tim_teknis/laporan.blade.php ENDPATH**/ ?>