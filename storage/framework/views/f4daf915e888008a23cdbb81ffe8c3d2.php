...
<body>
    ...
    <div class="kop-wrapper">
        <div class="kop-inner">
            <div class="kop-logo-kiri"><?php if($logoKiriB64): ?><img src="<?php echo e($logoKiriB64); ?>" alt="Logo Dinas"><?php endif; ?></div>
            <div class="kop-teks">
    ...
    <div class="judul-laporan">
        ...
        <p>Tanggal Cetak: <?php echo e(now()->translatedFormat('d F Y')); ?></p>
    </div>
    ...
    <table>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $laporanWarga; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $laporan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td style="text-align: center;"><?php echo e($index + 1); ?></td>
                    <td><?php echo e(\Carbon\Carbon::parse($laporan->created_at)->translatedFormat('d M Y')); ?><br><?php echo e(\Carbon\Carbon::parse($laporan->created_at)->format('H:i')); ?></td>
                    <td><strong><?php echo e($laporan->nama_pelapor); ?></strong><br><?php echo e($laporan->no_hp); ?></td>
                    <td><?php echo e($laporan->deskripsi); ?></td>
                    <td><?php echo e($laporan->latitude); ?><br><?php echo e($laporan->longitude); ?></td>
                    <td>
                        <?php if($laporan->label_ai): ?>
                            ...
                            ?>
                            <span style="display: inline-block; padding: 3px 8px; font-size: 10px; font-weight: bold; text-transform: uppercase; border-radius: 3px; border: 1px solid; <?php echo e($badgeClass); ?>"><?php echo e(strtoupper($laporan->label_ai)); ?></span><br>
                            <span style="font-size: 9px; color: #555; margin-top: 3px; display: inline-block;">Skor: <?php echo e($laporan->skor_ai ? round($laporan->skor_ai * 100) . '%' : '-'); ?></span>
                        <?php else: ?>
                            <span style="color:#999; font-style:italic;">-</span>
                        <?php endif; ?>
                    </td>
                    <td><strong><?php echo e(strtoupper($laporan->status)); ?></strong></td>
                </tr>
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\admin\pdf-laporan-warga.blade.php ENDPATH**/ ?>