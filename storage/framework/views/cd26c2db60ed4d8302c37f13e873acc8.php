        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-8 pb-16">
            ...
            <div class="relative bg-navy-900 rounded-[2.5rem] p-10 mb-8 overflow-hidden shadow-xl shadow-navy-900/10">
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                    <div>
                        <h3 class="text-3xl font-black text-white mb-3 leading-tight">Selamat Datang, <span class="text-gold-500"><?php echo e(auth()->user()->name); ?></span>!</h3>
                    ...
                    <a href="<?php echo e(route('surveyor.input')); ?>" class="shrink-0 px-8 py-4 bg-gold-500 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-gold-600 transition-all shadow-lg shadow-gold-500/20 flex items-center gap-3 group">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                <div class="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-3xl border border-blue-100 dark:border-blue-500/20 shadow-sm hover:-translate-y-1 transition-transform">
                    ...
                    <h3 class="text-3xl font-black text-blue-600 dark:text-blue-400"><?php echo e($totalSurvey); ?> <span class="text-[10px] font-bold text-slate-400">Laporan</span></h3>
                </div>
                ...
                <div class="bg-orange-50 dark:bg-orange-900/20 p-6 rounded-3xl border border-orange-100 dark:border-orange-500/20 shadow-sm hover:-translate-y-1 transition-transform">
                    ...
                    <h3 class="text-3xl font-black text-orange-600 dark:text-orange-400"><?php echo e($waitingValidation); ?> <span class="text-[10px] font-bold text-slate-400">Objek</span></h3>
                </div>
                ...
                <div class="bg-emerald-50 dark:bg-emerald-900/20 p-6 rounded-3xl border border-emerald-100 dark:border-emerald-500/20 shadow-sm hover:-translate-y-1 transition-transform">
                    ...
                    <h3 class="text-3xl font-black text-emerald-600 dark:text-emerald-400"><?php echo e($verifiedAI); ?> <span class="text-[10px] font-bold text-slate-400">Selesai</span></h3>
                </div>
                ...
                <div class="bg-red-50 dark:bg-red-900/20 p-6 rounded-3xl border border-red-100 dark:border-red-500/20 shadow-sm hover:-translate-y-1 transition-transform">
                    ...
                    <h3 class="text-3xl font-black text-red-600 dark:text-red-400"><?php echo e($totalRejected); ?> <span class="text-[10px] font-bold text-red-400/50">Tindakan</span></h3>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                <a href="<?php echo e(route('surveyor.laporan')); ?>" class="block bg-indigo-50 dark:bg-indigo-900/20 p-6 rounded-3xl border border-indigo-100 dark:border-indigo-500/20 shadow-sm hover:border-indigo-500/50 transition-all group hover:-translate-y-1">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-2xl font-black text-indigo-600 dark:text-indigo-400"><?php echo e($totalTugas); ?></h3>
                        </div>
                    </div>
                </a>
                
                <a href="<?php echo e(route('surveyor.laporan', ['status' => 'Menunggu'])); ?>" class="block bg-orange-50 dark:bg-orange-900/20 p-6 rounded-3xl border border-orange-100 dark:border-orange-500/20 shadow-sm hover:border-orange-500/50 transition-all group hover:-translate-y-1">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-2xl font-black text-orange-600 dark:text-orange-400"><?php echo e($tugasMenunggu); ?></h3>
                        </div>
                    </div>
                </a>
                
                <a href="<?php echo e(route('surveyor.laporan', ['status' => 'Selesai'])); ?>" class="block bg-emerald-50 dark:bg-emerald-900/20 p-6 rounded-3xl border border-emerald-100 dark:border-emerald-500/20 shadow-sm hover:border-emerald-500/50 transition-all group hover:-translate-y-1">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-2xl font-black text-emerald-600 dark:text-emerald-400"><?php echo e($tugasSelesai); ?></h3>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gradient-to-br from-[#0f0e2c] to-navy-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-lg shadow-navy-900/10 border border-white/5">
                        ...
                        <div class="relative z-10 flex items-center justify-between gap-4">
                            ...
                            <div class="w-16 h-16 bg-white dark:bg-[#1e1b4b]/10 backdrop-blur-md rounded-2xl flex items-center justify-center text-blue-400 shadow-inner border border-white/10 shrink-0">
                    ...
                    <div class="bg-navy-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-lg shadow-navy-900/10">
                        ...
                        <div class="relative z-10">
                            <div class="flex justify-between items-start mb-8">
                                ...
                                <button onclick="toggleModal('territoryModal')" class="px-4 py-2 bg-white dark:bg-[#1e1b4b]/5 hover:bg-white dark:bg-[#1e1b4b]/10 text-gold-500 border border-white/10 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all backdrop-blur-md">
                            ...
                            <div class="grid grid-cols-1 gap-3">
                                ...
                                <div class="bg-white dark:bg-[#1e1b4b]/5 border border-white/10 rounded-2xl p-4 backdrop-blur-md flex items-center gap-4 transition-transform hover:-translate-y-1 cursor-default">
                                    ...
                                    <h5 class="text-sm font-black text-gold-500 uppercase tracking-wider"><?php echo e($assignedKec->nama_kecamatan); ?></h5>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="bg-white dark:bg-[#1e1b4b]/5 border border-white/10 rounded-2xl p-6 backdrop-blur-md text-center">
                    ...
                    <div class="bg-white dark:bg-[#1e1b4b] rounded-[2.5rem] p-8 border border-slate-100 dark:border-white/10 shadow-sm">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <a href="<?php echo e(route('surveyor.history')); ?>" class="text-[10px] font-black text-gold-500 uppercase tracking-widest hover:text-gold-600 transition-colors">Semua Riwayat</a>
                        </div>
                        <div class="space-y-4">
                            <?php $__empty_1 = true; $__currentLoopData = $recentUploads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upload): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="flex items-center gap-4 p-3 hover:bg-slate-50 dark:hover:bg-white/5 dark:bg-[#0f0e2c] rounded-2xl border border-transparent hover:border-slate-100 dark:border-white/10 transition-all group cursor-pointer">
                                <div class="w-12 h-12 rounded-xl bg-slate-100 overflow-hidden flex-shrink-0 relative">
                                    <img src="<?php echo e(asset('storage/' . $upload->foto_terbaru)); ?>" class="w-full h-full object-cover">
                                    <div class="absolute inset-0 bg-navy-900/10 group-hover:bg-transparent transition-colors"></div>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs font-black text-navy-900 dark:text-white truncate uppercase"><?php echo e($upload->nama_infrastruktur); ?></p>
                                    <p class="text-[9px] text-slate-400 font-bold uppercase"><?php echo e($upload->created_at->diffForHumans()); ?></p>
                                </div>
                                <?php if($upload->status_verifikasi == 'Verified'): ?>
                                    <div class="px-2 py-1 bg-emerald-50 text-emerald-600 border border-emerald-100 rounded-lg text-[8px] font-black uppercase tracking-wider">Verified</div>
                                <?php else: ?>
                                    <div class="px-2 py-1 bg-orange-50 text-orange-600 border border-orange-100 rounded-lg text-[8px] font-black uppercase tracking-wider">Pending</div>
                                <?php endif; ?>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                        ...
                        <label class="relative flex items-center gap-3 p-4 bg-slate-50 dark:bg-[#0f0e2c] rounded-2xl border border-slate-100 dark:border-white/10 cursor-pointer hover:bg-gold-50 hover:border-gold-200 transition-all group">
                            <input type="checkbox" name="id_kecamatan[]" value="<?php echo e($kec->id_kecamatan); ?>" 
                                <?php echo e(in_array($kec->id_kecamatan, $assignedIds) ? 'checked' : ''); ?>

                                class="w-5 h-5 rounded-lg text-gold-500 focus:ring-gold-500 border-slate-300 transition-all cursor-pointer">
                            <span class="text-xs font-bold text-slate-600 dark:text-slate-400 group-hover:text-navy-900 dark:text-white uppercase"><?php echo e($kec->nama_kecamatan); ?></span>
                        </label>
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views/surveyor/dashboard.blade.php ENDPATH**/ ?>