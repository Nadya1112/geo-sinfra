            ...
            <div id="v2-welcome-card" style="border: 5px solid red !important;" class="relative bg-gradient-to-br from-emerald-700 to-teal-900 rounded-[2.5rem] p-10 mb-8 overflow-hidden shadow-lg shadow-emerald-900/10">
                ...
                <div class="relative z-10">
                    ...
                    <div style="margin-top: 20px !important;">
                        <a href="<?php echo e(route('surveyor.input')); ?>" style="background: white !important; color: blue !important; padding: 12px 24px !important; border-radius: 12px !important; font-weight: bold !important; text-decoration: none !important; display: inline-block !important;">
