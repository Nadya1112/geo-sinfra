            ...
            <div id="v2-welcome-card" style="border: 5px solid red !important;" class="relative bg-gradient-to-br from-emerald-700 to-teal-900 rounded-[2.5rem] p-10 mb-8 overflow-hidden shadow-lg shadow-emerald-900/10">
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex gap-4">
                        <a href="<?php echo e(route('surveyor.input')); ?>" class="px-8 py-4 bg-white text-emerald-800 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-emerald-50 transition-all inline-block shadow-2xl">
