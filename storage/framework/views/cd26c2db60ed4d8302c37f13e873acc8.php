        ...
        <header class="bg-white border-b border-gray-100 px-8 py-5 flex justify-between items-center z-10">
            ...
            <div class="relative bg-gradient-to-br from-emerald-600 to-teal-800 rounded-[2.5rem] p-10 mb-8 overflow-hidden shadow-lg shadow-emerald-900/10">
                ...
                <div class="relative z-10">
                    <h3 class="text-3xl font-black text-white mb-2 leading-tight">Selamat Datang, <?php echo e(auth()->user()->name); ?>!</h3>
                    ...
                    <div class="mt-8 flex gap-4">
                        <a href="<?php echo e(route('surveyor.input')); ?>" class="px-6 py-3 bg-white text-emerald-700 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-emerald-50 transition-all inline-block shadow-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                    ...
                    <h3 class="text-2xl font-black text-[#1e1b4b]"><?php echo e($totalSurvey); ?> <span class="text-xs font-medium text-gray-400">Laporan</span></h3>
                </div>
                <div class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                    ...
                    <h3 class="text-2xl font-black text-[#1e1b4b]"><?php echo e($waitingValidation); ?> <span class="text-xs font-medium text-gray-400">Objek</span></h3>
                </div>
                <div class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                    ...
                    <h3 class="text-2xl font-black text-[#1e1b4b]"><?php echo e($verifiedAI); ?> <span class="text-xs font-medium text-gray-400">Selesai</span></h3>
                </div>
            </div>
                ...
                <div class="space-y-6">
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="grid grid-cols-1 gap-3">
                                ...
                                <div class="bg-white/5 border border-white/10 rounded-2xl p-4 backdrop-blur-md flex items-center gap-4">
                                    ...
                                    <h5 class="text-md font-black"><?php echo e($assignedKec->nama_kecamatan); ?></h5>
                                </div>
                    ...
                    <div class="bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-sm">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <a href="<?php echo e(route('surveyor.history')); ?>" class="text-[10px] font-black text-emerald-600 uppercase tracking-widest hover:underline">Semua</a>
                        </div>
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center gap-4 p-3 hover:bg-gray-50 rounded-2xl transition-all">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs font-black text-[#1e1b4b] truncate uppercase"><?php echo e($upload->nama_infrastruktur); ?></p>
                                    <p class="text-[9px] text-gray-400 font-bold uppercase"><?php echo e($upload->created_at->diffForHumans()); ?></p>
                                </div>
                                <div class="w-2 h-2 rounded-full <?php echo e($upload->status_verifikasi == 'Verified' ? 'bg-emerald-500' : 'bg-amber-500'); ?>"></div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <form action="<?php echo e(route('surveyor.territory.update')); ?>" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                        ...
                        <label class="relative flex items-center gap-3 p-4 bg-gray-50 rounded-2xl border border-transparent cursor-pointer hover:bg-emerald-50 hover:border-emerald-200 transition-all group">
                            ...
                            <span class="text-sm font-bold text-gray-700 group-hover:text-[#1e1b4b]"><?php echo e($kec->nama_kecamatan); ?></span>
                        </label>
