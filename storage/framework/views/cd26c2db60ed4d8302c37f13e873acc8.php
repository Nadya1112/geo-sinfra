    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-8 pb-16">
            ...
            <div class="relative bg-navy-900 rounded-[2.5rem] p-10 mb-8 overflow-hidden shadow-xl shadow-navy-900/10">
                ...
                <div class="absolute -left-10 -bottom-10 w-64 h-64 bg-navy-500/20 rounded-full blur-3xl pointer-events-none"></div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:-translate-y-1 transition-transform">
                    ...
                    <h3 class="text-3xl font-black text-navy-900"><?php echo e($totalSurvey); ?> <span class="text-[10px] font-bold text-slate-400">Laporan</span></h3>
                </div>
                
                <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:-translate-y-1 transition-transform">
                    <div class="flex items-start justify-between mb-4">
                        <div class="w-11 h-11 bg-orange-50 text-orange-500 rounded-2xl flex items-center justify-center">
                            <i class="fas fa-clock"></i>
                        </div>
                    </div>
                    <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1">Menunggu Validasi</p>
                    <h3 class="text-3xl font-black text-navy-900"><?php echo e($waitingValidation); ?> <span class="text-[10px] font-bold text-slate-400">Objek</span></h3>
                </div>
                
                <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:-translate-y-1 transition-transform">
                    <div class="flex items-start justify-between mb-4">
                        <div class="w-11 h-11 bg-emerald-50 text-emerald-500 rounded-2xl flex items-center justify-center">
                ...
                <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:-translate-y-1 transition-transform">
                    ...
                    <h3 class="text-3xl font-black text-red-600"><?php echo e($totalRejected); ?> <span class="text-[10px] font-bold text-red-400/50">Tindakan</span></h3>
                </div>
            </div>
                    ...
                    <div class="bg-navy-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-lg shadow-navy-900/10">
                        ...
                        <div class="relative z-10">
                            <div class="flex justify-between items-start mb-8">
                                ...
                                <button onclick="toggleModal('territoryModal')" class="px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all backdrop-blur-md">
                                    <i class="fas fa-edit mr-2 text-gold-500"></i> Kelola
                                </button>
                            </div>
                            ...
                            <div class="grid grid-cols-1 gap-3">
                                ...
                                <div class="bg-white/5 border border-white/10 rounded-2xl p-4 backdrop-blur-md flex items-center gap-4">
                                    ...
                                    <h5 class="text-sm font-black uppercase tracking-wider"><?php echo e($assignedKec->nama_kecamatan); ?></h5>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-md text-center">
                                    <p class="text-[10px] text-slate-400 font-bold uppercase">Belum ada wilayah tugas.</p>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
