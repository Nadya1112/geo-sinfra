...
<body style="font-family: 'Inter', sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
        <h2 style="color: #1e1b4b;">Halo, <?php echo e($name); ?>!</h2>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="<?php echo e(url('/reset-password/'.$token)); ?>" class="button" style="color: #ffffff;">
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\auth\emails\reset.blade.php ENDPATH**/ ?>