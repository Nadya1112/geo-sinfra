...
<body class="bg-slate-50 dark:bg-[#0f0e2c] flex h-screen overflow-hidden text-slate-800 dark:text-white text-left font-sans dark:bg-navy-950 transition-colors duration-300">
    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden text-left font-sans relative">
        ...
        <div class="flex-1 overflow-y-auto p-8 custom-scrollbar">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-8 no-print">
                ...
                <div class="relative overflow-hidden rounded-[2rem] p-6 shadow-xl shadow-blue-500/20 hover:-translate-y-1 transition-transform bg-gradient-to-br from-blue-500 to-blue-700">
                    ...
                    <div class="relative z-10 flex flex-col justify-between h-full">
                        ...
                        <div class="flex items-end gap-2">
                            <h3 class="text-4xl font-black text-white leading-none"><?php echo e($totalLaporan); ?></h3>
                ...
                <div class="relative overflow-hidden rounded-[2rem] p-6 shadow-xl shadow-emerald-500/20 hover:-translate-y-1 transition-transform bg-gradient-to-br from-emerald-400 to-emerald-600">
                    ...
                    <div class="relative z-10 flex flex-col justify-between h-full">
                        ...
                        <div class="flex items-end gap-2">
                            <h3 class="text-4xl font-black text-white leading-none"><?php echo e($totalBaik); ?></h3>
                ...
                <div class="relative overflow-hidden rounded-[2rem] p-6 shadow-xl shadow-amber-500/20 hover:-translate-y-1 transition-transform bg-gradient-to-br from-amber-400 to-orange-500">
                    ...
                    <div class="relative z-10 flex flex-col justify-between h-full">
                        ...
                        <div class="flex items-end gap-2">
                            <h3 class="text-4xl font-black text-white leading-none"><?php echo e($totalSedang); ?></h3>
                            <span class="text-xs font-bold text-white/80 uppercase mb-1">Lokasi</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative overflow-hidden rounded-[2rem] p-6 shadow-xl shadow-rose-500/20 hover:-translate-y-1 transition-transform bg-gradient-to-br from-rose-500 to-rose-600">
                    ...
                    <div class="relative z-10 flex flex-col justify-between h-full">
                        ...
                        <div class="flex items-end gap-2">
                            <h3 class="text-4xl font-black text-white leading-none"><?php echo e($totalBerat); ?></h3>
                            <span class="text-xs font-bold text-white/80 uppercase mb-1">Lokasi</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-[#1e1b4b] rounded-[2rem] p-5 md:p-8 border border-slate-100 dark:border-white/10 shadow-sm mb-4 no-print">
                <form id="filterForm" action="<?php echo e(route('tim_teknis.laporan')); ?>" method="GET" class="flex flex-col gap-4 md:gap-6">
                    ...
                    <div class="flex flex-col md:flex-row md:flex-nowrap gap-4 md:gap-6 items-end">
                        <div class="w-full md:flex-1">
                            ...
                            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Ketik infrastruktur..." class="w-full bg-slate-50 dark:bg-[#0f0e2c] border border-slate-100 dark:border-white/10 rounded-xl px-4 py-2.5 text-xs font-bold text-navy-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-gold-500/20 focus:border-gold-500 transition-all">
                        </div>
                        <div class="w-full md:flex-1">
                    ...
                    <div class="flex flex-col md:flex-row md:flex-nowrap gap-4 md:gap-6 items-end">
                        <div class="w-full md:flex-1">
                            ...
                            <input type="date" name="start_date" value="<?php echo e(request('start_date')); ?>" class="w-full bg-slate-50 dark:bg-[#0f0e2c] border border-slate-100 dark:border-white/10 rounded-xl px-4 py-2.5 text-xs font-bold text-navy-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-gold-500/20 focus:border-gold-500 transition-all">
                        </div>
                        <div class="w-full md:flex-1">
                            <label class="text-xs font-black text-slate-400 uppercase tracking-widest block mb-2">Sampai Tanggal</label>
                            <input type="date" name="end_date" value="<?php echo e(request('end_date')); ?>" class="w-full bg-slate-50 dark:bg-[#0f0e2c] border border-slate-100 dark:border-white/10 rounded-xl px-4 py-2.5 text-xs font-bold text-navy-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-gold-500/20 focus:border-gold-500 transition-all">
                        </div>
                        <div class="w-full md:flex-1 flex gap-2 justify-start md:justify-end mt-2 md:mt-0">
                            ...
                            <a href="<?php echo e(route('tim_teknis.laporan')); ?>" class="px-4 py-2.5 bg-slate-50 dark:bg-[#0f0e2c] text-slate-400 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-slate-100 hover:text-slate-600 transition-all flex items-center border border-slate-100 dark:border-white/10 shadow-sm" title="Reset Filter">
            ...
            <div id="kopSurat" class="hidden print-only mb-6 pb-4" style="border-bottom: 4px double black;">
                <div class="flex items-center gap-6" style="display: flex; align-items: center; justify-content: center;">
                    <img src="<?php echo e(asset('logo_dinas.jpeg')); ?>" style="width: 80px; height: auto;" alt="Logo Instansi">
            ...
            <div id="docTitle" class="hidden print-only mb-8" style="text-align: center;">
                ...
                <div style="font-size: 10pt; display: flex; justify-content: flex-start; gap: 60px; padding-top: 8px; margin-top: 8px;">
                    ...
                    <span><strong>Periode:</strong> <?php echo e(\Carbon\Carbon::parse(request('start_date'))->translatedFormat('d M Y')); ?> &ndash; <?php echo e(\Carbon\Carbon::parse(request('end_date'))->translatedFormat('d M Y')); ?></span>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="print-no-style bg-white dark:bg-[#1e1b4b] rounded-[2rem] border border-slate-100 dark:border-white/10 shadow-sm overflow-hidden mt-4">
                ...
                <div class="px-4 md:px-8 py-4 md:py-6 border-b border-slate-50 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-slate-50 dark:bg-[#0f0e2c]/30 no-print">
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 w-full md:w-auto">
                        ...
                        <form action="<?php echo e(route('tim_teknis.laporan')); ?>" method="GET" class="flex items-center gap-2 w-full sm:w-auto">
                            ...
                            <select name="show" onchange="this.form.submit()" class="w-full sm:w-auto pl-4 pr-10 py-2 bg-white dark:bg-[#0f0e2c] border border-slate-200 dark:border-white/10 rounded-xl text-xs font-bold text-navy-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-gold-500 appearance-none shadow-sm cursor-pointer">
                                <option value="15" <?php echo e(request('show') == '15' || !request('show') ? 'selected' : ''); ?>>1 Halaman (±15 Baris)</option>
                                <option value="30" <?php echo e(request('show') == '30' ? 'selected' : ''); ?>>2 Halaman (±30 Baris)</option>
                                <option value="45" <?php echo e(request('show') == '45' ? 'selected' : ''); ?>>3 Halaman (±45 Baris)</option>
                                <option value="75" <?php echo e(request('show') == '75' ? 'selected' : ''); ?>>5 Halaman (±75 Baris)</option>
                                <option value="150" <?php echo e(request('show') == '150' ? 'selected' : ''); ?>>10 Halaman (±150 Baris)</option>
                                <option value="all" <?php echo e(request('show') == 'all' ? 'selected' : ''); ?>>Semua Halaman</option>
                            </select>
                        </form>
                    </div>
                </div>
                <?php if(request('search') || request('kecamatan') || request('kondisi') || request('jenis')): ?>
                <div class="bg-navy-50/50 px-6 py-4 border-b border-navy-100/50 flex flex-wrap items-center gap-3 no-print">
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('tim_teknis.laporan')); ?>" class="ml-auto text-xs font-bold text-red-400 hover:text-red-600 transition-all">
                ...
                <div class="overflow-x-auto w-full custom-scrollbar">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="group hover:bg-slate-50 dark:bg-[#0f0e2c]/50 transition-all">
                            <td class="px-6 py-3 text-xs font-bold text-slate-400 text-center"><?php echo e(request('show') == 'all' ? $index + 1 : ($reports->currentPage() - 1) * $reports->perPage() + $index + 1); ?></td>
                            <td class="px-6 py-3">
                                <span class="text-xs font-black text-navy-900 dark:text-white uppercase"><?php echo e($item->nama_objek); ?></span><br style="mso-data-placement:same-cell;">
                                <span class="text-xs text-slate-400 font-bold uppercase"><?php echo e($item->jenis); ?></span>
                            </td>
                            <td class="px-6 py-3">
                                <span class="text-xs font-bold text-navy-900 dark:text-white"><?php echo e($item->kelurahan->nama_kelurahan ?? '-'); ?></span><br style="mso-data-placement:same-cell;">
                                <span class="text-xs text-slate-400 font-bold uppercase"><?php echo e($item->kelurahan->kecamatan->nama_kecamatan ?? '-'); ?></span>
                            </td>
                            <td class="px-6 py-3">
                                <div class="flex justify-center">
                                    ...
                                    ?>
                                    <span class="px-2.5 py-1 rounded-md text-xs font-black uppercase border tracking-widest badge-print <?php echo e($condClass); ?>">
                        ...
                        <tr>
                            <td colspan="5" style="border: none !important; padding-top: 40px !important;">
                                <div style="float: right; text-align: center; width: 260px; font-family: 'Times New Roman', Times, serif; font-size: 11pt; page-break-inside: avoid;">
                                    <p style="margin-bottom: 4px;">Banjarmasin, <?php echo e(now()->translatedFormat('d F Y')); ?></p>
    ...
    <script>
        ...
        <?php if(request('autoExportExcel') == 'true'): ?>
            window.addEventListener('load', function() {
                setTimeout(function() {
                    exportTableToExcel('Laporan-Infrastruktur-<?php echo e(date("Y-m-d")); ?>.xls');
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\tim_teknis\laporan.blade.php ENDPATH**/ ?>