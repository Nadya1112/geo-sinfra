                                ...
                                <div class="grid grid-cols-1 gap-5">
                                    <div>
                                        ...
                                        <div class="relative group">
                                            ...
                                            <input type="text" name="nama_infrastruktur" value="<?php echo e(old('nama_infrastruktur', $infrastruktur->nama_objek)); ?>" placeholder="Contoh: Gg. Manggis RT 02 / Jalan Hasan Basry" class="w-full pl-12 pr-5 py-4 bg-slate-50  border border-slate-200  rounded-2xl text-sm font-semibold focus:ring-4 focus:ring-gold-500/10 focus:border-gold-500 outline-none transition-all text-navy-900 " required>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="bg-white  rounded-[2.5rem] p-8 border border-slate-100  shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <div class="grid grid-cols-1 gap-4 pt-4 border-t border-slate-100 ">
                                <div class="flex items-center justify-between px-2 mb-2">
                                    <span class="text-xs font-black text-slate-400 uppercase tracking-widest">Tgl Survey: <span class="text-navy-900 "><?php echo e(\Carbon\Carbon::parse($infrastruktur->tgl_survey)->translatedFormat('d M Y')); ?></span></span>
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\surveyor\edit.blade.php ENDPATH**/ ?>