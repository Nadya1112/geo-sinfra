                                ...
                                <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                                    <div class="relative w-1/2 h-1/2 border-2 border-red-500/50 bg-red-500/5 animate-pulse">
                                        ...
                                        <div class="absolute -top-6 left-0 bg-red-500 text-white text-[8px] font-black px-2 py-0.5 rounded-md shadow-lg tracking-widest">
                                            AI VISUAL DETECTED (<?php echo e(round(($hasilCnn->skor_cnn ?? 0) * 100)); ?>%)
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>
                    ...
                    <div class="bg-navy-900 rounded-[2.5rem] p-8 text-white shadow-xl relative overflow-hidden border border-navy-800">
                        ...
                        <div class="space-y-8 relative z-10">
                            ...
                            <div class="relative">
                                ...
                                <p class="text-[8px] font-bold text-slate-400 mt-2 italic text-right"><?php echo e($hasilCnn->label_kondisi ?? 'Memindai visual lapangan...'); ?></p>
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <p class="text-[8px] font-bold mt-2 italic text-right <?php echo e(($infrastruktur->analisis->label_prioritas ?? '') == 'Rusak Berat' ? 'text-red-400' : (($infrastruktur->analisis->label_prioritas ?? '') == 'Rusak Sedang' ? 'text-amber-400' : 'text-emerald-400')); ?>">
                                    Label: <?php echo e($infrastruktur->analisis->label_prioritas ?? 'Mengkalkulasi...'); ?>
