                    ...
                    <div class="bg-white rounded-[2.5rem] p-4 border border-slate-100 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                        <div class="relative h-64 rounded-[2rem] overflow-hidden bg-navy-950 group flex items-center justify-center">
                            ...
                            <div class="absolute inset-0 bg-navy-900/60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all backdrop-blur-sm">
                                <a href="<?php echo e(asset('storage/' . (str_contains($cleanPath, 'infrastruktur/') ? $cleanPath : 'infrastruktur/' . $cleanPath))); ?>" target="_blank" class="bg-gold-500 text-white px-5 py-2.5 rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-gold-600 hover:scale-105 transition-all shadow-xl">
                    ...
                    <div class="bg-navy-900 rounded-[2.5rem] p-8 text-white shadow-xl relative overflow-hidden border border-navy-800">
                        ...
                        <div class="space-y-8 relative z-10">
                            ...
                            <div class="relative">
                                ...
                                <p class="text-[8px] font-bold text-slate-400 mt-2 italic text-right"><?php echo e($hasilCnn->label_kondisi ?? 'Memeriksa visual lapangan...'); ?></p>
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <p class="text-[8px] font-bold mt-2 italic text-right <?php echo e(($infrastruktur->analisis->label_prioritas ?? '') == 'Rusak Berat' ? 'text-red-400' : (($infrastruktur->analisis->label_prioritas ?? '') == 'Rusak Sedang' ? 'text-amber-400' : 'text-emerald-400')); ?>">
                        ...
                        <div class="pt-2">
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                ...
                                <div class="bg-white p-4 rounded-[1.5rem] border border-slate-200 shadow-sm text-center">
                                    ...
                                    <span class="text-[11px] font-black text-navy-900"><?php echo e($infrastruktur->material_eksisting ?? '-'); ?></span>
                                </div>
                                <div class="bg-white p-4 rounded-[1.5rem] border border-slate-200 shadow-sm text-center">
