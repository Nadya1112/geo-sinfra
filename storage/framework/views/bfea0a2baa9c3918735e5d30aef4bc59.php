    ...
    <main class="flex-1 overflow-y-auto custom-scrollbar text-left relative">
        <header class="sticky top-0 bg-white/80 backdrop-blur-xl border-b border-slate-100 px-4 pl-16 md:px-8 py-4 flex justify-between items-center z-40 text-left shadow-sm">
            <div class="flex items-center gap-2 md:gap-4">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="hidden md:flex w-8 h-8 md:w-10 md:h-10 items-center justify-center bg-white text-slate-400 rounded-xl hover:bg-gold-50 hover:text-gold-600 transition-all border border-slate-200 hover:border-gold-200">
            ...
            <div class="flex items-center gap-3 md:gap-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="<?php echo e(route('admin.profile')); ?>" class="w-8 h-8 md:w-10 md:h-10 bg-navy-900 rounded-xl flex items-center justify-center text-gold-500 border border-white/10 overflow-hidden shadow-md">
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\admin\simulasi-ai.blade.php ENDPATH**/ ?>