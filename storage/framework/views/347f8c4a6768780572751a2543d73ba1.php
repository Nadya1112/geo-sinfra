        ...
        <div class="flex-1 p-8 overflow-y-auto custom-scrollbar">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                ...
                <div class="flex flex-row flex-nowrap items-center gap-2 w-full md:w-auto">
                    <form action="<?php echo e(route('admin.users')); ?>" method="GET" class="flex items-center flex-1 min-w-0 md:w-[400px]">
                    ...
                    <a href="<?php echo e(route('admin.users.create')); ?>" class="bg-gold-500 text-white text-xs px-4 md:px-6 py-2.5 rounded-2xl font-bold shadow-lg shadow-gold-500/10 hover:bg-gold-600 hover:shadow-gold-500/20 transition flex items-center justify-center gap-2 whitespace-nowrap shrink-0">
                            ...
                            <td class="px-4 md:px-4 py-3">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-400 font-bold uppercase mt-1 italic">ID: #<?php echo e(str_pad($user->id, 4, '0', STR_PAD_LEFT)); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-4 md:px-4 py-3 text-xs font-medium text-slate-500"><?php echo e($user->email); ?></td>
                            <td class="px-4 md:px-4 py-3">
