                        ...
                        <tr class="hover:bg-slate-50/50 transition">
                            ...
                            <td class="px-8 py-5">
                                <div class="flex justify-center gap-2">
                                    ...
                                    <a href="<?php echo e(route('admin.users.edit', $user->id)); ?>" title="Edit User" class="w-8 h-8 bg-slate-50 text-slate-400 hover:text-gold-500 hover:bg-gold-500/10 rounded-lg transition flex items-center justify-center">
...
</html><?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views/admin/users.blade.php ENDPATH**/ ?>