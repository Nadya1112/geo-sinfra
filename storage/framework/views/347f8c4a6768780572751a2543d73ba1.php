                        ...
                        <tr class="hover:bg-slate-50/50 transition">
                            ...
                            <td class="px-8 py-5">
                                <div class="flex items-center gap-4">
                                    <div class="w-10 h-10 <?php echo e($user->role == 'admin' ? 'bg-gold-500/10 text-gold-500 border-gold-500/20' : ($user->role == 'tim_teknis' ? 'bg-navy-900/10 text-navy-900 border-navy-900/20' : 'bg-slate-100 text-slate-600 border-slate-200')); ?> rounded-xl flex items-center justify-center font-bold text-xs border">
                            ...
                            <td class="px-8 py-5">
                                <span class="px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-tighter 
                                    <?php echo e($user->role == 'admin' ? 'bg-gold-500/10 text-gold-500 border border-gold-500/20' : ($user->role == 'tim_teknis' ? 'bg-navy-900/10 text-navy-900 border border-navy-900/20' : 'bg-slate-100 text-slate-600 border border-slate-200')); ?>">
                            ...
                            <td class="px-8 py-5">
                                <div class="flex justify-center gap-2">
                                    ...
                                    <?php else: ?>
                                    <span class="px-3 h-8 bg-slate-100 text-slate-400 text-[10px] font-bold rounded-lg flex items-center justify-center cursor-not-allowed gap-2" title="Akun Tim Teknis dilindungi sistem">
