                ...
                <form action="<?php echo e(url()->current()); ?>" method="GET" class="relative group">
                    <select name="year" onchange="this.form.submit()" 
                        ...
                        <?php $__currentLoopData = $availableYears ?? [$year]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($y); ?>" <?php echo e($y == $year ? 'selected' : ''); ?>>Tahun <?php echo e($y); ?></option>
                ...
                <div class="flex items-start justify-between mb-6 relative">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-400 font-semibold mt-0.5">Kurva-S kumulatif data survey per bulan · Tahun <?php echo e($year); ?></p>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-8">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-400 font-semibold mt-0.5">Tahun <?php echo e($year); ?></p>
                        </div>
                    </div>
                            ...
                            <div class="flex items-center gap-3 mb-3">
                                ...
                                <div class="flex-1 flex justify-between items-center">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <span class="text-xs font-bold text-slate-400"><?php echo e($pct); ?>%</span>
                                        <span class="text-sm font-black text-navy-900"><?php echo e($s->total); ?> <span class="text-xs text-slate-400 font-semibold">titik</span></span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-8">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-400 font-semibold mt-0.5">Rekapitulasi wilayah · Tahun <?php echo e($year); ?></p>
                        </div>
                    </div>
                                ...
                                <tr class="hover:bg-slate-50/60 transition-colors">
                                    <td class="px-3 py-3">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <p class="text-xs font-black text-navy-900 uppercase"><?php echo e($item['nama']); ?></p>
                                        </div>
                                    </td>
                                    <td class="px-3 py-3 text-center">
                                        <span class="text-xs font-black text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-lg"><?php echo e($item['baik']); ?></span>
                                    </td>
                                    <td class="px-3 py-3 text-center">
                                        <span class="text-xs font-black text-orange-600 bg-orange-50 px-2 py-0.5 rounded-lg"><?php echo e($item['sedang']); ?></span>
                                    </td>
                                    <td class="px-3 py-3 text-center">
                                        <span class="text-xs font-black text-red-600 bg-red-50 px-2 py-0.5 rounded-lg"><?php echo e($item['berat']); ?></span>
                                    </td>
                                    <td class="px-3 py-3 text-right">
                                        <span class="text-xs font-black text-navy-900 bg-navy-50 border border-navy-100 px-2 py-0.5 rounded-lg"><?php echo e($item['total']); ?></span>
                                    </td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\admin\statistik-tahunan.blade.php ENDPATH**/ ?>