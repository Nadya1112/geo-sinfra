    ...
    <main class="flex-1 overflow-y-auto custom-scrollbar">
        <header class="sticky top-0 bg-white/80 backdrop-blur-md border-b border-gray-100 px-8 py-5 flex justify-between items-center z-40">
            <div class="flex items-center gap-4 text-left">
                ...
                <div class="text-left">
                    <p class="text-[10px] font-extrabold text-blue-600 uppercase tracking-[0.2em] mb-1">Yearly Report <?php echo e($year); ?></p>
                ...
                <div class="relative z-10">
                    <div class="flex justify-between items-start mb-8">
                        ...
                        <div class="px-4 py-2 bg-blue-50 rounded-xl">
                            <span class="text-[10px] font-black text-blue-600 uppercase tracking-widest">Tahun <?php echo e($year); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="group">
                            <div class="flex justify-between items-center mb-2">
                                ...
                                <span class="text-xs font-black text-[#1e1b4b]"><?php echo e($s->total); ?> <span class="text-[10px] text-gray-400 font-medium">Titik</span></span>
                            </div>
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                ...
                                <tr class="group hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="py-4 px-2 text-center">
                                        <span class="text-[10px] font-black text-yellow-600"><?php echo e($item['ringan']); ?></span>
                                    </td>
                                    <td class="py-4 px-2 text-center">
