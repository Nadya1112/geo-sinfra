            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-md hover:-translate-y-1 transition-all">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="flex items-baseline gap-2">
                            <h2 class="text-3xl font-black text-navy-900"><?php echo e($kpi['total']); ?></h2>
                ...
                <div class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-md hover:-translate-y-1 transition-all">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="flex items-baseline gap-2">
                            <h2 class="text-3xl font-black text-navy-900"><?php echo e($kpi['validated']); ?></h2>
                            <span class="text-[10px] font-bold text-slate-400 uppercase">Unit</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-md hover:-translate-y-1 transition-all">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="flex items-baseline gap-2">
                            <h2 class="text-3xl font-black text-navy-900"><?php echo e($kpi['rejected']); ?></h2>
                            <span class="text-[10px] font-bold text-slate-400 uppercase">Unit</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-md hover:-translate-y-1 transition-all">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="flex items-baseline gap-2">
                            <h2 class="text-3xl font-black text-[#be123c]"><?php echo e($kpi['berat']); ?></h2>
                            <span class="text-[10px] font-bold text-slate-400 uppercase">Unit</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="group">
                            <div class="flex justify-between items-center mb-2">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-xs font-bold text-navy-900 uppercase"><?php echo e($s->jenis); ?></span>
                                </div>
                                <span class="text-xs font-black text-navy-900"><?php echo e($s->total); ?> <span class="text-[10px] text-slate-400 font-medium">Unit</span></span>
                            </div>
                ...
                <div class="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm flex flex-col">
                    ...
                    <div class="flex-1 relative flex items-center justify-center min-h-[200px]">
                        ...
                        <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                            <span class="text-3xl font-black text-navy-900"><?php echo e(array_sum($donutData)); ?></span>
                            ...
                            <tr class="group hover:bg-slate-50/50 transition-colors">
                                <td class="py-5 px-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <p class="text-xs font-bold text-navy-900 uppercase"><?php echo e($item['nama']); ?></p>
                                    </div>
                                </td>
                                <td class="py-5 px-4">
                                    <div class="flex items-center gap-3">
                                        <span class="text-[10px] font-black text-[#059669] w-6 text-right"><?php echo e($item['baik']); ?></span>
                                        <div class="flex-1 h-1.5 bg-slate-100 rounded-full overflow-hidden">
                                            <div class="h-full bg-[#059669] rounded-full" style="width: <?php echo e($item['total'] > 0 ? ($item['baik'] / $item['total'] * 100) : 0); ?>%"></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="py-5 px-4">
                                    <div class="flex items-center gap-3">
                                        <?php $sedang = ($item['ringan'] ?? 0) + ($item['sedang'] ?? 0); ?>
                                        <span class="text-[10px] font-black text-[#d97706] w-6 text-right"><?php echo e($sedang); ?></span>
                                        <div class="flex-1 h-1.5 bg-slate-100 rounded-full overflow-hidden">
                                            <div class="h-full bg-[#d97706] rounded-full" style="width: <?php echo e($item['total'] > 0 ? ($sedang / $item['total'] * 100) : 0); ?>%"></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="py-5 px-4">
                                    <div class="flex items-center gap-3">
                                        <span class="text-[10px] font-black text-[#be123c] w-6 text-right"><?php echo e($item['berat']); ?></span>
                                        <div class="flex-1 h-1.5 bg-slate-100 rounded-full overflow-hidden">
                                            <div class="h-full bg-[#be123c] rounded-full" style="width: <?php echo e($item['total'] > 0 ? ($item['berat'] / $item['total'] * 100) : 0); ?>%"></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="py-5 px-4 text-right">
                                    <span class="text-[10px] font-black text-navy-900 bg-slate-100 border border-slate-200 px-3 py-1.5 rounded-xl"><?php echo e($item['total']); ?> Unit</span>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
