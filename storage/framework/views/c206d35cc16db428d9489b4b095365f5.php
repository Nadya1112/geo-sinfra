            ...
            <div class="w-full max-w-md">
                ...
                <form action="<?php echo e(route('register')); ?>" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="email" placeholder="nama@disperkim.go.id atau NIP" value="<?php echo e(old('email')); ?>" required 
                            class="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-gold-500 focus:border-gold-500 focus:bg-white outline-none transition-all text-sm font-semibold text-navy-900">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="no_hp" placeholder="Contoh: 08123456789" value="<?php echo e(old('no_hp')); ?>" required 
                            class="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-gold-500 focus:border-gold-500 focus:bg-white outline-none transition-all text-sm font-semibold text-navy-900">
                    </div>

                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-2.5 ml-1">
                            Pilih Jabatan <span class="text-gold-500">*</span>
                        </label>
                        <div class="relative">
                ...
                <div class="mt-8 pt-6 border-t border-slate-100 text-center font-bold text-xs uppercase tracking-wider">
                    <p class="text-slate-400 text-[10px]">
                        Sudah punya akun? 
                        <a href="<?php echo e(route('login')); ?>" class="text-gold-500 font-extrabold hover:text-gold-600 transition-colors ml-1">Masuk di sini</a>
                    </p>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views/auth/register.blade.php ENDPATH**/ ?>