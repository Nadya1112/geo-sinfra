        ...
        <div class="flex-1 p-8 overflow-y-auto custom-scrollbar">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                ...
                <div class="flex flex-wrap items-center gap-3 w-full md:w-auto">
                    <form action="<?php echo e(route('admin.wilayah')); ?>" method="GET" class="flex items-center flex-1 md:w-80">
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari nama kecamatan atau kelurahan..." class="flex-1 pl-6 pr-4 py-2.5 bg-white border border-gray-100 rounded-l-2xl text-xs font-semibold focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all shadow-sm">
            ...
            <div class="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm overflow-hidden">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <?php $__empty_1 = true; $__currentLoopData = $wilayah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wly): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50/50 transition">
                            <td class="px-8 py-5">
                                <span class="px-3 py-1.5 bg-gray-100 text-gray-600 rounded-lg text-xs font-bold font-mono">
                                    <?php echo e($wly->id_kelurahan); ?>
