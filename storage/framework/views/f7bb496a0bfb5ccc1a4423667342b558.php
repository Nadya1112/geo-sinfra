            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                ...
                <div class="flex flex-wrap items-center gap-3 w-full md:w-auto">
                    <form action="<?php echo e(route('admin.wilayah')); ?>" method="GET" class="flex items-center flex-1 md:w-[400px]">
                        ...
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari nama kecamatan atau kelurahan..." class="flex-1 pl-4 pr-4 py-2.5 bg-white border border-slate-100 text-xs font-semibold focus:outline-none focus:ring-4 focus:ring-gold-500/10 focus:border-gold-500 transition-all shadow-sm">
                    ...
                    <a href="<?php echo e(route('admin.wilayah.create')); ?>" class="bg-gold-500 text-white text-xs px-6 py-2.5 rounded-2xl font-bold shadow-lg shadow-gold-500/10 hover:bg-gold-600 hover:shadow-gold-500/20 transition flex items-center gap-2 whitespace-nowrap">
                ...
                <div class="overflow-x-auto w-full custom-scrollbar"><table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-slate-50/50 transition">
                            ...
                            <td class="px-4 py-3">
                                <p class="text-xs font-black text-navy-900 uppercase leading-none"><?php echo e($wly->nama_kecamatan); ?></p>
                            </td>
                            <td class="px-4 py-3">
                                <p class="text-sm font-bold text-navy-900 leading-relaxed max-w-sm truncate" title="<?php echo e($wly->nama_kelurahan); ?>">
                            ...
                            <td class="px-4 py-3 text-center">
                                <span class="px-3 py-1 bg-emerald-50 border border-emerald-100 text-emerald-600 rounded-xl text-xs font-black">
                                    <?php echo e($wly->total_aset ?? 0); ?> Titik
                                </span>
                            </td>
                            <td class="px-4 py-3">
                                <div class="flex justify-center gap-2">
                                    <a href="<?php echo e(route('admin.wilayah.edit', $wly->id_kelurahan)); ?>" title="Edit Wilayah" class="w-8 h-8 flex items-center justify-center bg-gold-500 hover:bg-gold-600 text-white rounded-lg text-xs font-black transition shadow-sm hover:scale-105">
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views/admin/wilayah.blade.php ENDPATH**/ ?>