    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto">
        ...
        <div class="p-8">
            <div class="max-w-6xl mx-auto">
                <form id="survey-form" action="<?php echo e(route('surveyor.store')); ?>" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-2 gap-8" onsubmit="disableSubmitButton()">
                    <?php echo csrf_field(); ?>
                                    ...
                                    <div>
                                        ...
                                        <select name="id_kelurahan" id="id_kelurahan" class="w-full px-5 py-3 bg-gray-50 border border-gray-300 rounded-2xl text-sm font-semibold focus:border-emerald-500 outline-none appearance-none cursor-pointer" required>
                                            ...
                                            <?php $__currentLoopData = $semuaKelurahan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($kel->id_kelurahan); ?>" data-kecamatan="<?php echo e($kel->id_kecamatan); ?>"><?php echo e($kel->nama_kelurahan); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
