    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto custom-scrollbar bg-[#f8fafc]">
        <header class="bg-white/80 backdrop-blur-md border-b border-gray-100 px-8 py-5 flex justify-between items-center sticky top-0 z-[1000]">
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('surveyor.dashboard')); ?>" class="w-10 h-10 flex items-center justify-center bg-white text-gray-400 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-all border border-gray-100 shadow-sm">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="flex items-center gap-3">
                    <div class="text-right">
                        <p class="text-[10px] font-black text-[#1e1b4b] leading-none uppercase"><?php echo e(auth()->user()->name); ?></p>
                                    ...
                                    <div>
                                        ...
                                        <div class="grid grid-cols-3 gap-4">
                                            ...
                                            <label class="cursor-pointer group">
                                                <input type="radio" name="jenis_infrastruktur" value="<?php echo e($type); ?>" class="peer hidden" <?php echo e($loop->first ? 'checked' : ''); ?>>
                                    ...
                                    <div class="pt-2">
                                        ...
                                        <div class="mt-3 flex flex-wrap gap-2">
                                            ...
                                            <?php $__currentLoopData = ['Putus', 'Hancur', 'Amblas', 'Retak', 'Lubang', 'Goyang', 'Total', 'Parah']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyword): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <button type="button" onclick="addKeyword('<?php echo e($keyword); ?>')" class="px-2.5 py-1 bg-white border border-gray-100 rounded-lg text-[9px] font-bold text-gray-500 hover:bg-emerald-500 hover:text-white hover:border-emerald-500 transition-all shadow-sm active:scale-95">
                                                    + <?php echo e($keyword); ?>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="grid grid-cols-1 gap-4 pt-2">
                                        <div class="flex items-center justify-between px-2">
                                            <span class="text-[9px] font-black text-gray-400 uppercase tracking-widest">Tgl Survey: <?php echo e(date('d/m/Y')); ?></span>
