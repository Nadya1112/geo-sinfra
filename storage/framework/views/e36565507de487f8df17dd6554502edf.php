            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="glass-card p-6 rounded-[2rem] shadow-sm border border-indigo-50 relative overflow-hidden group">
                    ...
                    <div class="flex items-end gap-3">
                        <h3 class="text-4xl font-black text-[#1e1b4b]"><?php echo e($usulan->count()); ?></h3>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <?php $__empty_1 = true; $__currentLoopData = $usulan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50/50 transition-colors group">
                                <td class="px-8 py-6">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p class="text-[9px] font-black text-indigo-500 uppercase tracking-tighter mb-0.5"><?php echo e($item->jenis_infrastruktur); ?></p>
                                            <h4 class="text-sm font-black text-[#1e1b4b] leading-tight"><?php echo e($item->nama_infrastruktur); ?></h4>
                                            <p class="text-[10px] text-gray-400 font-bold mt-1 uppercase"><?php echo e($item->created_at->translatedFormat('d M Y')); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-6">
                                    <div class="flex flex-col gap-1">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-[11px] font-bold text-gray-600"><?php echo e($item->kelurahan->nama_kelurahan ?? '-'); ?></span>
                                        </div>
                                        <div class="flex items-center gap-2">
                                            <i class="fas fa-user text-gray-300 text-[10px]"></i>
                                            <span class="text-[10px] font-black text-gray-400 uppercase"><?php echo e($item->user->name ?? 'Surveyor'); ?></span>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-6">
                                    <div class="flex flex-col gap-2">
                                        <div class="flex items-center justify-between bg-emerald-50 px-2 py-1 rounded-lg border border-emerald-100">
                                            ...
                                            <span class="text-[10px] font-black text-emerald-700"><?php echo e($item->cnn ? number_format($item->cnn->skor_cnn * 100, 1) . '%' : '-'); ?></span>
                                        </div>
                                        <div class="flex items-center justify-between bg-blue-50 px-2 py-1 rounded-lg border border-blue-100">
                                            ...
                                            <span class="text-[9px] font-black text-blue-700 uppercase"><?php echo e($item->analisis->label_prioritas ?? '-'); ?></span>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-6">
                                    ...
                                    ?>
                                    <span class="px-3 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest bg-<?php echo e($color); ?>-50 text-<?php echo e($color); ?>-600 border border-<?php echo e($color); ?>-100">
                                ...
                                <td class="px-8 py-6">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <a href="<?php echo e(route('surveyor.infrastruktur.show', $item->id_infrastruktur)); ?>" target="_blank" class="w-9 h-9 flex items-center justify-center bg-gray-50 text-gray-400 rounded-xl hover:bg-indigo-50 hover:text-indigo-600 transition-all border border-gray-100 group/btn">
