                ...
                <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="nama_infrastruktur"
                                           value="<?php echo e(old('nama_infrastruktur')); ?>" placeholder="Contoh: Titian Jl. Kelayan A, Gang Mutiara..."
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 space-y-3">
                            ...
                            <a href="<?php echo e(route('admin.laporan-warga')); ?>" class="w-full flex items-center justify-center gap-2 bg-slate-100 hover:bg-slate-200 text-slate-500 py-3.5 rounded-2xl font-black text-sm tracking-widest transition-all uppercase">
