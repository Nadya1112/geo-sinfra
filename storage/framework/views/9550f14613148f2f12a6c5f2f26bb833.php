    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        <header class="bg-white dark:bg-[#1e1b4b] border-b border-slate-100 dark:border-white/10 px-4 pl-20 md:pl-4 md:px-8 py-3 md:py-4 flex justify-between items-center z-40 sticky top-0">
            <div class="flex items-center gap-2 md:gap-4 min-w-0">
                <a href="<?php echo e(route('tim_teknis.dashboard')); ?>" class="w-10 h-10 flex items-center justify-center bg-slate-50 dark:bg-[#0f0e2c] text-slate-400 rounded-xl hover:bg-gold-50 hover:text-gold-500 transition-all border border-slate-100 dark:border-white/10 hidden md:flex flex-shrink-0">
                ...
                <div class="bg-[#1e1b4b]/95 backdrop-blur-xl p-3 rounded-2xl border border-white/10 shadow-2xl w-48 flex flex-col gap-2">
                    ...
                    <div id="territory-card" class="w-full relative">
                        ...
                        <div id="territory-options" class="hidden mt-0.5 p-0.5 flex-col overflow-y-auto custom-scrollbar" style="max-height: 20vh;">
                            ...
                            <button onclick="toggleKecamatan('<?php echo e($kec->id_kecamatan); ?>')" class="kec-btn w-full px-3 py-1.5 rounded-lg text-[7px] font-black uppercase tracking-wider text-slate-400 hover:bg-white/10 transition-all flex items-center justify-between group" data-id="<?php echo e($kec->id_kecamatan); ?>">
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <span class="whitespace-normal leading-tight group-hover:text-white transition-colors text-left"><?php echo e($kec->nama_kecamatan); ?></span>
                                </div>
                                <div class="w-2.5 h-2.5 rounded border border-white/10 shrink-0" style="background-color: <?php echo e($kec->warna ?? '#6366f1'); ?>;"></div>
                            </button>
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\tim_teknis\monitoring.blade.php ENDPATH**/ ?>