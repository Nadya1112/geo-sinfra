...
<aside class="w-64 bg-[#0f0e2c] text-white flex-col hidden md:flex shadow-2xl z-20 text-left border-r border-white/5 shrink-0 h-screen">
        ...
        <nav class="space-y-1.5">
            ...
            <a href="<?php echo e(route('admin.laporan-warga')); ?>" 
               class="flex items-center justify-between px-4 py-3.5 <?php echo e(request()->routeIs('admin.laporan-warga*') ? 'bg-gold-500 text-navy-950 font-bold shadow-xl shadow-gold-500/10' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?> rounded-xl text-sm font-semibold transition group text-left relative w-full">
                ...
                <span class="bg-red-500 text-white text-xs font-black px-1.5 py-0.5 rounded-md min-w-[20px] text-center shadow-lg"><?php echo e($laporanMenungguCount); ?></span>
                <?php endif; ?>
            </a>
    ...
    <div class="p-6 border-t border-white/5 text-left bg-navy-950/20 relative">
        ...
        <a href="<?php echo e(route('admin.settings')); ?>" class="flex items-center gap-3 px-4 py-3 mb-2 <?php echo e(request()->routeIs('admin.settings') ? 'bg-gold-500 text-navy-950 font-bold shadow-xl shadow-gold-500/10' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?> rounded-xl text-sm font-bold transition group">
...
<aside id="mobile-sidebar" class="fixed top-0 left-0 w-72 h-full bg-[#0f0e2c] text-white flex flex-col z-[9999] shadow-2xl transform -translate-x-full transition-transform duration-300 ease-in-out md:hidden">
    ...
    <div class="p-6 border-t border-white/5 text-left bg-navy-950/20 relative">
        ...
        <a href="<?php echo e(route('admin.settings')); ?>" class="flex items-center gap-3 px-4 py-3.5 mb-2 <?php echo e(request()->routeIs('admin.settings') ? 'bg-gold-500 text-navy-950 font-bold shadow-xl shadow-gold-500/10' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?> rounded-xl text-sm font-bold transition group">
            <i class="fas fa-cog group-hover:text-gold-500 transition-colors"></i>
            <span>Pengaturan</span>
        </a>
