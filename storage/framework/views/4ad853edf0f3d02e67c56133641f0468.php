                            ...
                            <tr class="hover:bg-slate-50/60 transition-colors">
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex flex-col gap-1.5 items-center min-w-[90px]">
                                        ...
                                        <?php else: ?>
                                            <form action="<?php echo e(route('admin.infrastruktur.verifikasi', $inf->id_infrastruktur)); ?>" method="POST" class="w-full">
                                                <?php echo csrf_field(); ?>
                                        ...
                                        <a href="<?php echo e(route('admin.infrastruktur.show', $inf->id_infrastruktur)); ?>"
                                        ...
                                        <form action="<?php echo e(route('admin.infrastruktur.destroy', $inf->id_infrastruktur)); ?>" method="POST" class="w-full">
                                            <?php echo csrf_field(); ?>
