                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-50">
                            ...
                            <tr class="hover:bg-slate-50/60 transition-colors">
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-start gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-[9px] text-slate-500 font-semibold mt-0.5">Kel. <?php echo e($inf->nama_kelurahan ?? '-'); ?></p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex flex-col gap-1.5 items-center min-w-[130px]">
                                        <div class="flex items-center gap-2 w-full">
                                            ...
                                            <span class="text-[9px] font-bold <?php echo e($cnnLabel ? $cnnColor : 'text-slate-400'); ?> leading-none">
                                ...
                                <td class="px-5 py-4 text-center">
                                    <span class="inline-block px-3 py-1.5 rounded-xl text-[8px] font-black tracking-wider uppercase <?php echo e($labelColor); ?>">
