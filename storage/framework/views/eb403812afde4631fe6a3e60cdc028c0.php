                ...
                <?php $__empty_1 = true; $__currentLoopData = $prioritas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden hover:shadow-2xl transition-all duration-300 group relative">
                        ...
                        <div class="relative h-56 bg-slate-100 overflow-hidden">
                            ...
                            <div class="absolute bottom-5 left-5 right-5">
                                <span class="px-2.5 py-1 bg-white/20 backdrop-blur-md rounded border border-white/20 text-[9px] font-black uppercase tracking-widest text-white mb-2 inline-block">
                                    <?php echo e($item->jenis_infrastruktur ?? $item->jenis ?? 'Infrastruktur'); ?>
                        ...
                        <div class="p-6">
                            ...
                            <a href="<?php echo e(route('kabid.infrastruktur.show', $item->id ?? $item->id_infrastruktur)); ?>" class="flex items-center justify-center gap-2 w-full py-3.5 bg-navy-900 text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-gold-500 hover:text-white transition-all shadow-lg shadow-navy-900/20 group-hover:shadow-gold-500/30">
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views/kabid/prioritas.blade.php ENDPATH**/ ?>