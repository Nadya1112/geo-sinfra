...
<body class="antialiased">
    ...
    <nav class="bg-white border-b border-gray-100 h-24 flex items-center sticky top-0 z-[1000]">
        <div class="max-w-7xl mx-auto px-8 w-full flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center gap-8">
                ...
                <a href="<?php echo e(url('/login')); ?>" class="btn-internal">Login</a>
            </div>
        </div>
    </nav>
        ...
        <div class="max-w-7xl mx-auto px-8">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 reveal">
                <div class="card-stat border-t-4 border-navy group hover:border-gold transition-all duration-500">
                    ...
                    <p class="text-4xl font-black text-navy"><?php echo e(number_format($stats['total'] ?? 0)); ?></p>
                ...
                <div class="card-stat border-t-4 border-gold group hover:border-navy transition-all duration-500">
                    ...
                    <p class="text-4xl font-black text-navy"><?php echo e(number_format($stats['kecamatan'] ?? 0)); ?></p>
                ...
                <div class="card-stat border-t-4 border-red-500 group hover:border-red-600 transition-all duration-500">
                    ...
                    <p class="text-4xl font-black text-navy"><?php echo e(number_format($stats['rusak_berat'] ?? 0)); ?></p>
                ...
                <div class="card-stat bg-navy text-white group hover:bg-navy/90 transition-all duration-500 overflow-hidden relative">
                    <div class="relative z-10">
                        ...
                        <p class="text-4xl font-black text-white"><?php echo e($stats['akurasi_ai'] ?? 0); ?>%</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-12 reveal">
                        ...
                        <?php $__currentLoopData = $sebaranKecamatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nama => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                                <div class="flex justify-between text-[10px] font-bold uppercase mb-1">
                                    <span class="text-gray-500"><?php echo e($nama ?: 'Tanpa Wilayah'); ?></span>
                                    <?php if($count > 0): ?>
                                        <span class="text-navy"><?php echo e($count); ?> Titik</span>
                                    <?php endif; ?>
                                </div>
                                <div class="w-full bg-gray-100 h-2 rounded-full overflow-hidden">
                                    <div class="bg-navy h-full rounded-full" style="width: <?php echo e($stats['total'] > 0 ? ($count / $stats['total'] * 100) : 0); ?>%"></div>
                                </div>
                            </div>
                ...
                <div class="bg-navy p-8 rounded-2xl shadow-xl relative overflow-hidden flex flex-col justify-center">
                    <div class="relative z-10">
                        ...
                        <h5 class="text-3xl font-black text-white uppercase tracking-tighter mb-4"><?php echo e($topKategori); ?></h5>
                        <div class="flex items-baseline gap-2">
                            <span class="text-5xl font-black text-gold"><?php echo e(number_format($topKategoriCount)); ?></span>
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <?php $__currentLoopData = $kondisiWilayah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50/50 transition-all">
                                    <td class="px-8 py-4 text-sm font-bold text-navy"><?php echo e($item['nama'] ?: 'Lainnya'); ?></td>
                                    <td class="px-8 py-4 text-center text-sm font-black text-navy"><?php echo e($item['total']); ?></td>
                                    <td class="px-6 py-4 text-right pr-8">
                                        <span class="inline-block px-3 py-1 bg-red-50 text-red-600 rounded-full text-[10px] font-black"><?php echo e($item['rusak_berat']); ?></span>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
    ...
    <footer class="bg-navy py-12 text-white">
        <div class="max-w-7xl mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <p class="text-[9px] font-black text-gray-400 uppercase tracking-widest">&copy; <?php echo e(date('Y')); ?> PEMKOT BANJARMASIN. ALL RIGHTS RESERVED.</p>
        </div>
    </footer>
