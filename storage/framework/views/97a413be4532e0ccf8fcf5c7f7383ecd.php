    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-8 pb-16">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
                ...
                <a href="<?php echo e(route('admin.infrastruktur')); ?>" class="block stat-card bg-white rounded-3xl border border-slate-100 shadow-sm p-6 cursor-pointer">
                ...
                <a href="<?php echo e(route('admin.simulasi-ai')); ?>" class="block stat-card bg-white rounded-3xl border border-slate-100 shadow-sm p-6 cursor-pointer">
                    <div class="flex items-start justify-between mb-4">
                ...
                <a href="<?php echo e(route('admin.users')); ?>" class="block stat-card bg-white rounded-3xl border border-slate-100 shadow-sm p-6 cursor-pointer">
                    <div class="flex items-start justify-between mb-4">
                    ...
                    <h3 class="text-3xl font-black text-navy-900"><?php echo e($jumlahSurveyor + $jumlahTimTeknis); ?></h3>
                    <p class="text-xs text-slate-400 font-semibold mt-1"><?php echo e($jumlahSurveyor); ?> surveyor · <?php echo e($jumlahTimTeknis); ?> tim_teknis</p>
                </a>

                
                <a href="<?php echo e(route('admin.wilayah')); ?>" class="block stat-card bg-white rounded-3xl border border-slate-100 shadow-sm p-6 cursor-pointer">
                    <div class="flex items-start justify-between mb-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex justify-between items-center mb-1.5">
                                            ...
                                            <div class="flex items-center gap-2">
                                                <span class="text-xs font-bold <?php echo e($p['text']); ?>"><?php echo e($pct); ?>%</span>
                                                <span class="text-xs font-black text-navy-900"><?php echo e($p['count']); ?> <span class="text-xs text-slate-400 font-semibold">titik</span></span>
                                            </div>
                                        </div>
                                        ...
                                        <p class="text-xs <?php echo e($p['text']); ?> font-semibold mt-1"><?php echo e($p['desc']); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-3 w-full">
                                ...
                                <div class="bg-white/5 border border-white/10 rounded-2xl p-3">
                                    <div class="flex items-center gap-2 mb-1">
                                        ...
                                        <span class="text-xs font-bold text-slate-400 uppercase tracking-wider"><?php echo e($item['label']); ?></span>
                                    </div>
                                    <p class="text-xl font-black <?php echo e($item['text']); ?>"><?php echo e($item['count']); ?></p>
                                    <p class="text-xs text-slate-500 font-semibold"><?php echo e($total > 0 ? round(($item['count']/$total)*100) : 0); ?>%</p>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\admin\statistik.blade.php ENDPATH**/ ?>