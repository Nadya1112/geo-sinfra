    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        <header class="bg-white dark:bg-[#1e1b4b] border-b border-slate-100 dark:border-white/10 px-4 pl-20 md:px-8 py-4 flex justify-between items-center z-40 sticky top-0">
            <div class="flex items-center gap-4 min-w-0">
                ...
                <div class="min-w-0">
                    <p class="text-[9px] md:text-xs font-extrabold text-gold-500 uppercase tracking-[0.2em] mb-0.5 md:mb-1 truncate">Decision Support</p>
                    <h2 class="text-sm md:text-xl font-black text-navy-900 dark:text-white leading-tight whitespace-normal">Rekomendasi Prioritas</h2>
                </div>
            </div>
        ...
        <div class="flex-1 overflow-y-auto p-8 custom-scrollbar space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 pb-10">
                <?php $__empty_1 = true; $__currentLoopData = $prioritas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <!-- Card Item -->
                    <div class="bg-white dark:bg-[#1e1b4b] rounded-[2rem] border border-slate-100 dark:border-white/10 shadow-sm overflow-hidden hover:shadow-2xl transition-all duration-300 group relative">
                        ...
                        <div class="relative h-56 bg-slate-100 overflow-hidden">
                            <?php if($item->foto_terbaru): ?>
                                <img src="<?php echo e(str_contains($item->foto_terbaru, 'infrastruktur/') ? asset('storage/' . $item->foto_terbaru) : asset('storage/infrastruktur/' . $item->foto_terbaru)); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" onerror="this.src='/test.jpg'">
                            <?php else: ?>
                            ...
                            <div class="absolute bottom-5 left-5 right-5">
                                <span class="px-2.5 py-1 bg-white/20 dark:bg-[#1e1b4b]/20 backdrop-blur-md roun border border-white/20 text-xs font-black uppercase tracking-widest text-white mb-2 inline-block">
                                    <?php echo e(ucfirst($item->jenis) ?? 'Infrastruktur'); ?>

                                </span>
                                <h3 class="text-xl font-black text-white leading-tight line-clamp-2"><?php echo e($item->nama_objek ?? $item->nama_infrastruktur ?? 'Tanpa Nama'); ?></h3>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            <div class="flex items-start gap-3 mb-5 border-b border-slate-50 pb-5">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-bold text-navy-900 dark:text-white leading-tight">
                                        <?php echo e($item->kelurahan->nama_kelurahan ?? '-'); ?>, <?php echo e($item->kelurahan->kecamatan->nama_kecamatan ?? '-'); ?>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2 px-3 py-2 bg-rose-50 border border-rose-100 rounded-xl">
                                        ...
                                        <span class="text-xs font-black text-rose-600 uppercase tracking-widest whitespace-nowrap">
                                            <?php echo e($item->analisis->label_prioritas ?? 'Rusak Berat'); ?>
                            ...
                            <a href="<?php echo e(route('tim_teknis.infrastruktur.show', $item->id ?? $item->id_infrastruktur)); ?>" class="flex items-center justify-center gap-2 w-full py-3.5 bg-navy-900 text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-gold-500 hover:text-white transition-all shadow-lg shadow-navy-900/20 group-hover:shadow-gold-500/30">
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\tim_teknis\prioritas.blade.php ENDPATH**/ ?>