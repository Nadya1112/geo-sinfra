    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-8 pb-16">
            ...
            <div class="flex items-center gap-3 mb-6">
                ...
                <span class="text-xs text-slate-400 font-semibold"><?php echo e($inf->nama_objek ?? $inf->nama_infrastruktur); ?></span>
            </div>
                        ...
                        <div class="bg-navy-900 rounded-3xl p-6 text-white">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex justify-between items-center py-2 border-b border-white/10">
                                    ...
                                    <span class="text-xs font-black text-white"><?php echo e($cnnData->label_kondisi ?? 'Belum Dianalisis'); ?></span>
                                </div>
                                <div class="flex justify-between items-center py-2 border-b border-white/10">
                                ...
                                <div class="flex justify-between items-center py-2">
                                    ...
                                    <span class="text-xs font-black text-white"><?php echo e($dtData->label_prioritas ?? $inf->kondisi); ?></span>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views\admin\edit-infrastruktur.blade.php ENDPATH**/ ?>