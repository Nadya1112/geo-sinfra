    ...
    <div class="flex flex-col md:flex-row h-screen overflow-hidden">
        ...
        <div class="w-full md:w-1/2 bg-white flex flex-col items-center justify-center p-8 md:p-20 relative">
            ...
            <div class="absolute top-10 left-10 md:left-20">
                <a href="<?php echo e(route('login')); ?>" class="text-gray-400 hover:text-blue-600 transition-all text-2xl">
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="text-red-500 text-xs mt-1 italic"><?php echo e($message); ?></p>
                        <?php unset($message);
...
</html><?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>