    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header class="bg-white/80 backdrop-blur-xl border-b border-slate-100 px-8 py-5 flex justify-between items-center z-40 shrink-0">
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('surveyor.dashboard')); ?>" class="w-10 h-10 flex items-center justify-center bg-white border border-slate-200 text-slate-400 rounded-xl hover:bg-gold-50 hover:text-gold-600 hover:border-gold-200 transition-all shadow-sm">
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm text-center relative overflow-hidden">
                            ...
                            <div class="inline-flex items-center gap-1.5 px-3 py-1 bg-navy-50 border border-navy-100 rounded-lg mt-2">
                                ...
                                <p class="text-[10px] font-black text-navy-900 uppercase tracking-widest"><?php echo e(auth()->user()->role); ?></p>
                            </div>
                        </div>
                    </div>
