                ...
                <form action="<?php echo e(route('admin.wilayah.store')); ?>" method="POST">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="pt-8 flex gap-3">
                            ...
                            <a href="<?php echo e(route('admin.wilayah')); ?>" class="flex-1 bg-slate-100 text-slate-500 text-xs px-6 py-4 rounded-2xl font-bold hover:bg-slate-200 transition text-center flex items-center justify-center gap-2 tracking-widest uppercase">
                                Batal
                            </a>
                        </div>
                    </div>
...
</html><?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views/admin/create-wilayah.blade.php ENDPATH**/ ?>