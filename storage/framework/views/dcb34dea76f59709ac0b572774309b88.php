    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto custom-scrollbar">
        ...
        <header class="bg-white dark:bg-[#1e1b4b] border-b border-slate-100 dark:border-white/10 px-8 py-5 flex justify-between items-center z-10 sticky top-0">
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('tim_teknis.dashboard')); ?>" class="w-10 h-10 flex items-center justify-center bg-slate-50 dark:bg-[#0f0e2c] text-slate-400 rounded-xl hover:bg-gold-50 hover:text-gold-500 transition-all border border-slate-100 dark:border-white/10">
        ...
        <div class="p-8 space-y-8">
            ...
            <div class="bg-white dark:bg-[#1e1b4b] rounded-[3rem] shadow-sm border border-slate-100 dark:border-white/10 overflow-hidden mb-10">
                ...
                <div class="px-8 py-4 bg-white dark:bg-[#1e1b4b] border-b border-slate-100 dark:border-white/10">
                    <form action="<?php echo e(route('tim_teknis.validasi')); ?>" method="GET" class="flex flex-col gap-4">
                        ...
                        <div class="flex flex-wrap gap-2 mb-2">
                            <a href="<?php echo e(route('tim_teknis.validasi', array_merge(request()->query(), ['status' => 'All']))); ?>" class="px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all <?php echo e($currentStatus == 'All' ? 'bg-navy-900 text-white shadow-md' : 'bg-white dark:bg-[#1e1b4b] text-slate-400 hover:bg-slate-100 border border-slate-200 dark:border-white/20'); ?>">Semua Antrean</a>
                            <a href="<?php echo e(route('tim_teknis.validasi', array_merge(request()->query(), ['status' => 'Pending']))); ?>" class="px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all <?php echo e($currentStatus == 'Pending' ? 'bg-amber-500 text-white shadow-md shadow-amber-500/20' : 'bg-white dark:bg-[#1e1b4b] text-slate-400 hover:bg-slate-100 border border-slate-200 dark:border-white/20'); ?>">Menunggu (Pending)</a>
                            <a href="<?php echo e(route('tim_teknis.validasi', array_merge(request()->query(), ['status' => 'Validated']))); ?>" class="px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all <?php echo e($currentStatus == 'Validated' ? 'bg-emerald-500 text-white shadow-md shadow-emerald-500/20' : 'bg-white dark:bg-[#1e1b4b] text-slate-400 hover:bg-slate-100 border border-slate-200 dark:border-white/20'); ?>">Disetujui (Validated)</a>
                            <a href="<?php echo e(route('tim_teknis.validasi', array_merge(request()->query(), ['status' => 'Rejected']))); ?>" class="px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all <?php echo e($currentStatus == 'Rejected' ? 'bg-rose-500 text-white shadow-md shadow-rose-500/20' : 'bg-white dark:bg-[#1e1b4b] text-slate-400 hover:bg-slate-100 border border-slate-200 dark:border-white/20'); ?>">Ditolak / Perbaikan</a>
                        </div>
                        ...
                        <div class="flex flex-wrap md:flex-nowrap gap-4 items-end bg-slate-50 dark:bg-[#0f0e2c]/50 p-4 rounded-2xl border border-slate-100 dark:border-white/10">
                            ...
                            <div class="w-full md:flex-[0.5] flex gap-2 justify-end">
                                ...
                                <a href="<?php echo e(route('tim_teknis.validasi', ['status' => $currentStatus])); ?>" class="px-4 py-2.5 bg-white dark:bg-[#1e1b4b] text-slate-400 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-100 hover:text-slate-600 transition-all border border-slate-200 dark:border-white/20 shadow-sm flex items-center justify-center">
                ...
                <form id="bulkForm" action="<?php echo e(route('tim_teknis.validasi.bulk')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                            ...
                            <tr class="hover:bg-slate-50 dark:bg-[#0f0e2c]/50 transition-colors group">
                                <td class="px-6 py-5 text-center">
                                    <?php if($item->status_validasi == 'Pending'): ?>
                                        <input type="checkbox" name="ids[]" value="<?php echo e($item->id_infrastruktur); ?>" class="row-checkbox roun border-slate-300 text-gold-500 focus:ring-gold-500 cursor-pointer w-4 h-4">
                                    <?php else: ?>
                                ...
                                <td class="px-6 py-5 min-w-[150px]">
                                    <div class="flex flex-col gap-2 items-start">
                                        ...
                                        ?>
                                        <span class="px-2.5 py-1 rounded-md border text-[9px] font-black uppercase tracking-widest whitespace-nowrap <?php echo e($aiClass); ?>">
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views/tim_teknis/validasi.blade.php ENDPATH**/ ?>