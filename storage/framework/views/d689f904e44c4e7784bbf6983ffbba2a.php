    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto custom-scrollbar">
        ...
        <header class="bg-white dark:bg-[#1e1b4b] border-b border-slate-100 dark:border-white/10 px-8 py-5 flex justify-between items-center z-10 sticky top-0">
            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('tim_teknis.validasi')); ?>" class="w-10 h-10 flex items-center justify-center bg-slate-50 dark:bg-[#0f0e2c] text-slate-400 rounded-xl hover:bg-gold-50 hover:text-gold-500 transition-all border border-slate-100 dark:border-white/10">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="<?php echo e(route('tim_teknis.infrastruktur.pdf', $infrastruktur->id_infrastruktur)); ?>" target="_blank" class="px-3 py-1.5 bg-rose-50 text-rose-600 rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-rose-500 hover:text-white transition-colors border border-rose-100 flex items-center gap-2 shadow-sm">
                        ...
                        <div class="relative aspect-[3/4] w-full rounded-[2rem] overflow-hidden group bg-navy-950 flex items-center justify-center">
                            <?php if($fotoUrl): ?>
                                ...
                                <div class="absolute inset-0 bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                    <a href="<?php echo e($fotoUrl); ?>" target="_blank" class="bg-white dark:bg-[#1e1b4b] text-navy-900 dark:text-white px-4 py-2 rounded-xl text-[9px] font-black shadow-xl uppercase tracking-widest hover:scale-105 transition-all flex items-center gap-2">
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="pt-6 border-t border-white/10">
                                <div class="flex items-center justify-between mb-4">
                                    ...
                                    <span class="px-3 py-1 bg-white/5 dark:bg-[#1e1b4b]/5 border border-white/10 rounded-lg text-[8px] font-black uppercase tracking-widest <?php echo e($infrastruktur->status_verifikasi == 'Verified' ? 'text-[#059669]' : 'text-amber-400'); ?>">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white dark:bg-[#1e1b4b] rounded-[2.5rem] p-8 border border-slate-100 dark:border-white/10 shadow-sm">
                        <div class="flex justify-between items-start mb-8">
                            <div>
                                <p class="text-[10px] font-black text-gold-500 uppercase tracking-widest mb-1"><?php echo e(ucfirst($infrastruktur->jenis)); ?></p>
...
<?php /**PATH C:\laragon1\laragon\www\geo-sinfra\resources\views/tim_teknis/show.blade.php ENDPATH**/ ?>