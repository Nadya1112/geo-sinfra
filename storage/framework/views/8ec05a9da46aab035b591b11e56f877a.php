    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto">
        ...
        <div class="p-8 space-y-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <a href="<?php echo e(route('kabid.monitoring')); ?>" class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all group relative overflow-hidden">
                ...
                <a href="<?php echo e(route('kabid.verifikasi')); ?>" class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all group relative overflow-hidden">
                ...
                <a href="<?php echo e(route('kabid.statistik.tahunan')); ?>" class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all group relative overflow-hidden">
                    ...
                    <div class="relative z-10 flex flex-col h-full justify-between gap-6">
                        ...
                        <div>
                            <h4 class="font-black text-[#1e1b4b] text-sm uppercase tracking-tight mb-2">Statistik Laporan</h4>
                ...
                <a href="<?php echo e(route('kabid.laporan')); ?>" class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all group relative overflow-hidden">
            ...
            <div class="bg-white rounded-[3rem] p-8 border border-gray-100 shadow-sm overflow-hidden">
                <div class="flex justify-between items-center mb-8 px-4">
                    ...
                    <a href="<?php echo e(route('kabid.verifikasi')); ?>" class="text-[10px] font-black text-indigo-600 uppercase tracking-widest hover:bg-indigo-50 px-4 py-2 rounded-xl transition-all">Semua Laporan <i class="fas fa-arrow-right ml-2"></i></a>
                </div>
