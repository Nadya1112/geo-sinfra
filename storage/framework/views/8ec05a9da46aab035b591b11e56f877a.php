                    ...
                    <div class="bg-white/5 backdrop-blur-md rounded-3xl p-6 border border-white/10 group hover:bg-white/10 transition-all border-l-gold-500/50 border-l-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-black text-white"><?php echo e($totalInfrastruktur); ?> <span class="text-[10px] font-bold text-gold-300/50 italic ml-1">Objek</span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white/5 backdrop-blur-md rounded-3xl p-6 border border-white/10 group hover:bg-white/10 transition-all border-l-[#be123c]/50 border-l-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-black text-white"><?php echo e($totalRusakBerat); ?> <span class="text-[10px] font-bold text-[#be123c]/50 italic ml-1">Lokasi</span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white/5 backdrop-blur-md rounded-3xl p-6 border border-white/10 group hover:bg-white/10 transition-all border-l-[#d97706]/50 border-l-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-black text-white"><?php echo e($totalPending); ?> <span class="text-[10px] font-bold text-[#d97706]/50 italic ml-1">Laporan</span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white/5 backdrop-blur-md rounded-3xl p-6 border border-white/10 group hover:bg-white/10 transition-all border-l-blue-500/50 border-l-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-black text-white"><?php echo e($totalPerbaikan); ?> <span class="text-[10px] font-bold text-blue-400/50 italic ml-1">Proyek</span></h3>
                            </div>
                        </div>
                    </div>
                </div>
