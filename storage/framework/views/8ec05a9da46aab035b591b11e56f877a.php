            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group">
                    <div class="relative z-10">
                        ...
                        <h3 class="text-3xl font-black text-amber-500"><?php echo e($totalPending); ?></h3>
                ...
                <div class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group">
                    <div class="relative z-10">
                        ...
                        <h3 class="text-3xl font-black text-emerald-500"><?php echo e($totalVerified); ?></h3>
                ...
                <div class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group">
                    <div class="relative z-10">
                        ...
                        <h3 class="text-3xl font-black text-indigo-600"><?php echo e($totalInfrastruktur); ?></h3>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-6 p-4 rounded-3xl border border-gray-50 hover:border-indigo-100 hover:bg-indigo-50/30 transition-all group">
                            <div class="w-16 h-16 rounded-2xl bg-gray-100 overflow-hidden shadow-sm">
                                <img src="<?php echo e(asset('storage/' . $report->foto)); ?>" class="w-full h-full object-cover">
                            </div>
                            <div class="flex-1">
                                <p class="text-[9px] font-black text-indigo-500 uppercase tracking-widest mb-0.5"><?php echo e($report->jenis_infrastruktur); ?></p>
                                <h5 class="text-sm font-black text-[#1e1b4b] leading-tight mb-1"><?php echo e($report->nama_infrastruktur); ?></h5>
                                <div class="flex items-center gap-3">
                                    <p class="text-[10px] text-gray-400 font-bold uppercase tracking-tighter">Oleh: <span class="text-gray-600"><?php echo e($report->user->name ?? 'Surveyor'); ?></span></p>
                                    <div class="w-1 h-1 bg-gray-200 rounded-full"></div>
                                    <p class="text-[10px] text-gray-400 font-medium italic"><?php echo e($report->created_at->diffForHumans()); ?></p>
                                </div>
                            </div>
