    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto">
        ...
        <div class="p-8 space-y-10">
            ...
            <div class="relative bg-rose-500 rounded-[2.5rem] p-6 border border-rose-600 shadow-xl shadow-rose-500/30 flex items-center justify-between overflow-hidden group hover:scale-[1.01] transition-transform">
                ...
                <div class="relative z-10 flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-rose-100 text-sm font-medium">Sistem AI mendeteksi <strong class="text-white text-lg"><?php echo e($totalRusakBerat); ?> infrastruktur</strong> dalam kondisi kritis (Rusak Berat). Segera lakukan peninjauan dan alokasi anggaran perbaikan.</p>
                    </div>
                </div>
                <div class="relative z-10 hidden md:block">
                    <a href="<?php echo e(route('kabid.laporan')); ?>?kondisi=Berat" class="px-6 py-4 bg-white text-rose-600 rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-rose-50 transition-colors shadow-lg flex items-center gap-3">
                    ...
                    <div class="bg-white/5 backdrop-blur-md rounded-3xl p-6 border border-white/10 group hover:bg-white/10 transition-all border-l-amber-400/50 border-l-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-black text-white"><?php echo e($totalPending ?? 0); ?> <span class="text-[10px] font-bold text-amber-400/50 italic ml-1">Laporan</span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white/5 backdrop-blur-md rounded-3xl p-6 border border-white/10 group hover:bg-white/10 transition-all border-l-blue-300/50 border-l-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <h3 class="text-2xl font-black text-white"><?php echo e($totalPerbaikan ?? 0); ?> <span class="text-[10px] font-bold text-blue-300/50 italic ml-1">Proyek</span></h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <a href="<?php echo e(route('kabid.monitoring')); ?>" class="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all group relative overflow-hidden">
                ...
                <a href="<?php echo e(route('kabid.validasi')); ?>" class="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all group relative overflow-hidden">
                ...
                <a href="<?php echo e(route('kabid.statistik.tahunan')); ?>" class="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all group relative overflow-hidden">
                    <div class="absolute -right-6 -top-6 w-24 h-24 bg-navy-50 rounded-full group-hover:scale-150 transition-transform duration-700"></div>
                    <div class="relative z-10 flex flex-col h-full justify-between gap-6">
                ...
                <a href="<?php echo e(route('kabid.laporan')); ?>" class="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all group relative overflow-hidden">
                    <div class="absolute -right-6 -top-6 w-24 h-24 bg-gold-50 rounded-full group-hover:scale-150 transition-transform duration-700"></div>
                    <div class="relative z-10 flex flex-col h-full justify-between gap-6">
