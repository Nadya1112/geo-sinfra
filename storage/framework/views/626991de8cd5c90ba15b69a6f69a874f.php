                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <span class="px-2 py-0.5 bg-blue-50 text-blue-600 rounded-md text-[9px] font-black uppercase tracking-tighter"><?php echo e($item->jenis_infrastruktur); ?></span>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div>
                                            <p class="text-xs font-bold text-gray-700"><?php echo e($item->kelurahan ? $item->kelurahan->nama_kelurahan : '-'); ?></p>
                                            <p class="text-[9px] text-gray-400 font-medium uppercase tracking-widest"><?php echo e($item->created_at->translatedFormat('d M Y')); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <div class="flex flex-col items-center gap-1.5">
                                        <span class="px-2.5 py-1 rounded-lg text-[9px] font-black tracking-widest border <?php echo e($item->kondisi == 'Baik' ? 'bg-emerald-50 text-emerald-600 border-emerald-200' : ($item->kondisi == 'Rusak Ringan' ? 'bg-yellow-50 text-yellow-600 border-yellow-200' : ($item->kondisi == 'Rusak Berat' ? 'bg-red-50 text-red-600 border-red-200' : 'bg-gray-50 text-gray-500 border-gray-200'))); ?>">
                                            <?php echo e(strtoupper($item->kondisi)); ?>

                                        </span>
                                        <?php if($item->cnn || $item->analisis): ?>
                                        <div class="flex flex-col items-center gap-0.5">
                                            <?php if($item->cnn): ?>
                                                <p class="text-[8px] font-bold text-gray-400 uppercase tracking-tighter">CNN: <span class="text-emerald-500"><?php echo e(number_format($item->cnn->skor_cnn * 100, 1)); ?>%</span></p>
                                            <?php endif; ?>
                                            <?php if($item->analisis): ?>
                                                <p class="text-[8px] font-bold text-gray-400 uppercase tracking-tighter">D-Tree: <span class="text-blue-500"><?php echo e($item->analisis->label_prioritas); ?></span></p>
                                            <?php endif; ?>
                                        </div>
                                        <?php endif; ?>
                                    </div>
                                ...
                                <td class="px-8 py-4 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="<?php echo e(route('surveyor.infrastruktur.edit', $item->id_infrastruktur)); ?>" class="w-8 h-8 flex items-center justify-center bg-gray-100 text-gray-500 rounded-lg hover:bg-blue-500 hover:text-white transition-colors cursor-pointer" title="Edit Data">
                                            <i class="fas fa-pen text-xs"></i>
                                        </a>
                                        <a href="<?php echo e(route('surveyor.infrastruktur.show', $item->id_infrastruktur)); ?>" class="w-8 h-8 flex items-center justify-center bg-blue-50 text-blue-600 rounded-lg hover:bg-[#1e1b4b] hover:text-white transition-all shadow-sm border border-blue-100" title="Lihat Detail">
                            ...
                            <tr>
                                <td colspan="5" class="px-8 py-20 text-center">
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <a href="<?php echo e(route('surveyor.input')); ?>" class="mt-2 text-xs font-black text-emerald-600 uppercase tracking-widest hover:underline">Mulai Survey Pertama <i class="fas fa-plus ml-1"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php endif; ?>
